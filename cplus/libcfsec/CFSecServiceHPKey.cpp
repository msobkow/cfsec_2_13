// Description: C++18 implementation of a Service history primary key object.
...
namespace cfsec {
	...
	const std::string CFSecServiceHPKey::CLASS_NAME( "CFSecServiceHPKey" );
	const std::string CFSecServiceHPKey::S_VALUE( "value" );

	CFSecServiceHPKey::CFSecServiceHPKey()
	: CFSecHPKey()
	{
	...
	CFSecServiceHPKey::CFSecServiceHPKey( const CFSecServiceHPKey& src )
	: CFSecHPKey()
	{
		requiredClusterId = cfsec::CFSecServiceBuff::CLUSTERID_INIT_VALUE;
		requiredServiceId = cfsec::CFSecServiceBuff::SERVICEID_INIT_VALUE;
	...
	const int64_t CFSecServiceHPKey::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFSecServiceHPKey::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFSecServiceHPKey::setRequiredClusterId( const int64_t value ) {
	...
	const int64_t CFSecServiceHPKey::getRequiredServiceId() const {
		return( requiredServiceId );
	}

	const int64_t* CFSecServiceHPKey::getRequiredServiceIdReference() const {
		return( &requiredServiceId );
	}

	void CFSecServiceHPKey::setRequiredServiceId( const int64_t value ) {
	...
	size_t CFSecServiceHPKey::hashCode() const {
	...
	std::string CFSecServiceHPKey::toString() {
	...
	bool CFSecServiceHPKey::operator <( const CFSecServicePKey& rhs ) {
	...
	bool CFSecServiceHPKey::operator <( const CFSecServiceHPKey& rhs ) {
	...
	bool CFSecServiceHPKey::operator <( const CFSecServiceHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecServiceHPKey::operator <( const CFSecServiceBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	CFSecServiceHPKey CFSecServiceHPKey::operator =( cfsec::CFSecServicePKey& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredServiceId( src.getRequiredServiceId() );
		return( *this );
	}

	CFSecServiceHPKey CFSecServiceHPKey::operator =( cfsec::CFSecServiceHPKey& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredServiceId( src.getRequiredServiceId() );
		return( *this );
	}

	CFSecServiceHPKey CFSecServiceHPKey::operator =( cfsec::CFSecServiceBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredServiceId( src.getRequiredServiceId() );
		return( *this );
	}

	CFSecServiceHPKey CFSecServiceHPKey::operator =( cfsec::CFSecServiceHBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredServiceId( src.getRequiredServiceId() );
		return( *this );
	}
