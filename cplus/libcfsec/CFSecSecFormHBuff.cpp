// Description: C++18 implementation of a SecForm history buffer object.
...
namespace cfsec {
	...
	const std::string CFSecSecFormHBuff::CLASS_NAME( "CFSecSecFormHBuff" );
	CFSecSecFormHBuff::CFSecSecFormHBuff()
	...
	CFSecSecFormHBuff::CFSecSecFormHBuff( const CFSecSecFormHBuff& src )
	: CFSecHPKey(), cflib::ICFLibCloneableObj() {
		requiredClusterId = cfsec::CFSecSecFormBuff::CLUSTERID_INIT_VALUE;
		requiredSecFormId = cfsec::CFSecSecFormBuff::SECFORMID_INIT_VALUE;
		requiredSecAppId = cfsec::CFSecSecFormBuff::SECAPPID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFSecSecFormHBuff::clone() {
		CFSecSecFormHBuff* copy = new CFSecSecFormHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFSecSecFormHBuff::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFSecSecFormHBuff::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFSecSecFormHBuff::setRequiredClusterId( const int64_t value ) {
	...
	const int32_t CFSecSecFormHBuff::getRequiredSecFormId() const {
		return( requiredSecFormId );
	}

	const int32_t* CFSecSecFormHBuff::getRequiredSecFormIdReference() const {
		return( &requiredSecFormId );
	}

	void CFSecSecFormHBuff::setRequiredSecFormId( const int32_t value ) {
	...
	const int32_t CFSecSecFormHBuff::getRequiredSecAppId() const {
		return( requiredSecAppId );
	}

	const int32_t* CFSecSecFormHBuff::getRequiredSecAppIdReference() const {
		return( &requiredSecAppId );
	}

	void CFSecSecFormHBuff::setRequiredSecAppId( const int32_t value ) {
	...
	const std::string& CFSecSecFormHBuff::getRequiredJEEServletMapName() const {
		return( *requiredJEEServletMapName );
	}

	const std::string* CFSecSecFormHBuff::getRequiredJEEServletMapNameReference() const {
		return( requiredJEEServletMapName );
	}

	void CFSecSecFormHBuff::setRequiredJEEServletMapName( const std::string& value ) {
	...
	size_t CFSecSecFormHBuff::hashCode() const {
	...
	CFSecSecFormHBuff CFSecSecFormHBuff::operator =( cfsec::CFSecSecFormBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecFormId( src.getRequiredSecFormId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredSecAppId( src.getRequiredSecAppId() );
	...
	CFSecSecFormHBuff CFSecSecFormHBuff::operator =( cfsec::CFSecSecFormHBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecFormId( src.getRequiredSecFormId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredSecAppId( src.getRequiredSecAppId() );
	...
	bool CFSecSecFormHBuff::operator <( const CFSecSecFormByClusterIdxKey& rhs ) {
	...
	bool CFSecSecFormHBuff::operator <( const CFSecSecFormBySecAppIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecFormHBuff::operator <( const CFSecSecFormByUJEEServletIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecFormHBuff::operator <( const CFSecSecFormPKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecFormHBuff::operator <( const CFSecSecFormHPKey& rhs ) {
	...
	bool CFSecSecFormHBuff::operator <( const CFSecSecFormHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecSecFormHBuff::operator <( const CFSecSecFormBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	std::string CFSecSecFormHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFSecSecFormHBuff" );
