...
namespace cfsec {
	...
	public:
		CFSecSecDeviceByUserIdxKey();
		CFSecSecDeviceByUserIdxKey( const CFSecSecDeviceByUserIdxKey& src );
		virtual ~CFSecSecDeviceByUserIdxKey();
		...
		bool operator >( const CFSecSecDeviceHBuff& rhs );
		bool operator >( const CFSecSecDeviceBuff& rhs );
		cfsec::CFSecSecDeviceByUserIdxKey operator =( cfsec::CFSecSecDeviceByUserIdxKey& src );
		cfsec::CFSecSecDeviceByUserIdxKey operator =( cfsec::CFSecSecDeviceBuff& src );
		cfsec::CFSecSecDeviceByUserIdxKey operator =( cfsec::CFSecSecDeviceHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfsec::CFSecSecDeviceByUserIdxKey> {
		typedef cfsec::CFSecSecDeviceByUserIdxKey argument_type;
