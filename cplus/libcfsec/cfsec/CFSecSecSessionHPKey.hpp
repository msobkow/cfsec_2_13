...
// Description: C++18 specification of a SecSession history primary key object.
...
namespace cfsec {
	...
	class CFSecSecSessionHPKey : public CFSecHPKey
	{
	protected:
	...
	public:
		...
		CFSecSecSessionHPKey();
		CFSecSecSessionHPKey( const CFSecSecSessionHPKey& src );
		virtual ~CFSecSecSessionHPKey();
		...
		cfsec::CFSecSecSessionHPKey operator =( cfsec::CFSecSecSessionPKey& src );
		cfsec::CFSecSecSessionHPKey operator =( cfsec::CFSecSecSessionHPKey& src );
		cfsec::CFSecSecSessionHPKey operator =( cfsec::CFSecSecSessionBuff& src );
		cfsec::CFSecSecSessionHPKey operator =( cfsec::CFSecSecSessionHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfsec::CFSecSecSessionHPKey> {
		typedef cfsec::CFSecSecSessionHPKey argument_type;
