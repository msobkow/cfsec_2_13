...
namespace cfsec {
	...
	class CFSecTSecGroupBuff : public cflib::ICFLibCloneableObj
	{
	public:
	...
	public:
		...
		CFSecTSecGroupBuff( const CFSecTSecGroupBuff& src );

		virtual ~CFSecTSecGroupBuff();
		...
		bool operator >( const CFSecTSecGroupHBuff& rhs );
		bool operator >( const CFSecTSecGroupBuff& rhs );
		cfsec::CFSecTSecGroupBuff operator =( cfsec::CFSecTSecGroupBuff& src );
		cfsec::CFSecTSecGroupBuff operator =( cfsec::CFSecTSecGroupHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfsec::CFSecTSecGroupBuff> {
		typedef cfsec::CFSecTSecGroupBuff argument_type;
