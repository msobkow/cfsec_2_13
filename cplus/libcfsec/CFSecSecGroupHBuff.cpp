// Description: C++18 implementation of a SecGroup history buffer object.
...
namespace cfsec {
	...
	const std::string CFSecSecGroupHBuff::CLASS_NAME( "CFSecSecGroupHBuff" );
	CFSecSecGroupHBuff::CFSecSecGroupHBuff()
	...
	CFSecSecGroupHBuff::CFSecSecGroupHBuff( const CFSecSecGroupHBuff& src )
	: CFSecHPKey(), cflib::ICFLibCloneableObj() {
		requiredClusterId = cfsec::CFSecSecGroupBuff::CLUSTERID_INIT_VALUE;
		requiredSecGroupId = cfsec::CFSecSecGroupBuff::SECGROUPID_INIT_VALUE;
		requiredName = new std::string( cfsec::CFSecSecGroupBuff::NAME_INIT_VALUE );
	...
	cflib::ICFLibCloneableObj* CFSecSecGroupHBuff::clone() {
		CFSecSecGroupHBuff* copy = new CFSecSecGroupHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFSecSecGroupHBuff::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFSecSecGroupHBuff::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFSecSecGroupHBuff::setRequiredClusterId( const int64_t value ) {
	...
	const int32_t CFSecSecGroupHBuff::getRequiredSecGroupId() const {
		return( requiredSecGroupId );
	}

	const int32_t* CFSecSecGroupHBuff::getRequiredSecGroupIdReference() const {
		return( &requiredSecGroupId );
	}

	void CFSecSecGroupHBuff::setRequiredSecGroupId( const int32_t value ) {
	...
	const std::string& CFSecSecGroupHBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFSecSecGroupHBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFSecSecGroupHBuff::setRequiredName( const std::string& value ) {
	...
	const bool CFSecSecGroupHBuff::getRequiredIsVisible() const {
		return( requiredIsVisible );
	}

	const bool* CFSecSecGroupHBuff::getRequiredIsVisibleReference() const {
		return( &requiredIsVisible );
	}

	void CFSecSecGroupHBuff::setRequiredIsVisible( const bool value ) {
		requiredIsVisible = value;
	}

	size_t CFSecSecGroupHBuff::hashCode() const {
	...
	CFSecSecGroupHBuff CFSecSecGroupHBuff::operator =( cfsec::CFSecSecGroupBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecGroupId( src.getRequiredSecGroupId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredName( src.getRequiredName() );
	...
	CFSecSecGroupHBuff CFSecSecGroupHBuff::operator =( cfsec::CFSecSecGroupHBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecGroupId( src.getRequiredSecGroupId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredName( src.getRequiredName() );
	...
	bool CFSecSecGroupHBuff::operator <( const CFSecSecGroupByClusterIdxKey& rhs ) {
	...
	bool CFSecSecGroupHBuff::operator <( const CFSecSecGroupByClusterVisIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecGroupHBuff::operator <( const CFSecSecGroupByUNameIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecGroupHBuff::operator <( const CFSecSecGroupPKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecGroupHBuff::operator <( const CFSecSecGroupHPKey& rhs ) {
	...
	bool CFSecSecGroupHBuff::operator <( const CFSecSecGroupHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecSecGroupHBuff::operator <( const CFSecSecGroupBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	std::string CFSecSecGroupHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFSecSecGroupHBuff" );
