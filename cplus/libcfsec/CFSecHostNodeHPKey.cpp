// Description: C++18 implementation of a HostNode history primary key object.
...
namespace cfsec {
	...
	const std::string CFSecHostNodeHPKey::CLASS_NAME( "CFSecHostNodeHPKey" );
	const std::string CFSecHostNodeHPKey::S_VALUE( "value" );

	CFSecHostNodeHPKey::CFSecHostNodeHPKey()
	: CFSecHPKey()
	{
	...
	CFSecHostNodeHPKey::CFSecHostNodeHPKey( const CFSecHostNodeHPKey& src )
	: CFSecHPKey()
	{
		requiredClusterId = cfsec::CFSecHostNodeBuff::CLUSTERID_INIT_VALUE;
		requiredHostNodeId = cfsec::CFSecHostNodeBuff::HOSTNODEID_INIT_VALUE;
	...
	const int64_t CFSecHostNodeHPKey::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFSecHostNodeHPKey::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFSecHostNodeHPKey::setRequiredClusterId( const int64_t value ) {
	...
	const int64_t CFSecHostNodeHPKey::getRequiredHostNodeId() const {
		return( requiredHostNodeId );
	}

	const int64_t* CFSecHostNodeHPKey::getRequiredHostNodeIdReference() const {
		return( &requiredHostNodeId );
	}

	void CFSecHostNodeHPKey::setRequiredHostNodeId( const int64_t value ) {
	...
	size_t CFSecHostNodeHPKey::hashCode() const {
	...
	std::string CFSecHostNodeHPKey::toString() {
	...
	bool CFSecHostNodeHPKey::operator <( const CFSecHostNodePKey& rhs ) {
	...
	bool CFSecHostNodeHPKey::operator <( const CFSecHostNodeHPKey& rhs ) {
	...
	bool CFSecHostNodeHPKey::operator <( const CFSecHostNodeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecHostNodeHPKey::operator <( const CFSecHostNodeBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	CFSecHostNodeHPKey CFSecHostNodeHPKey::operator =( cfsec::CFSecHostNodePKey& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredHostNodeId( src.getRequiredHostNodeId() );
		return( *this );
	}

	CFSecHostNodeHPKey CFSecHostNodeHPKey::operator =( cfsec::CFSecHostNodeHPKey& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredHostNodeId( src.getRequiredHostNodeId() );
		return( *this );
	}

	CFSecHostNodeHPKey CFSecHostNodeHPKey::operator =( cfsec::CFSecHostNodeBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredHostNodeId( src.getRequiredHostNodeId() );
		return( *this );
	}

	CFSecHostNodeHPKey CFSecHostNodeHPKey::operator =( cfsec::CFSecHostNodeHBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredHostNodeId( src.getRequiredHostNodeId() );
		return( *this );
	}
