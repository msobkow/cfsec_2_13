// Description: C++18 implementation of a SecGrpMemb history buffer object.
...
namespace cfsec {
	...
	const std::string CFSecSecGrpMembHBuff::CLASS_NAME( "CFSecSecGrpMembHBuff" );
	CFSecSecGrpMembHBuff::CFSecSecGrpMembHBuff()
	...
	CFSecSecGrpMembHBuff::CFSecSecGrpMembHBuff( const CFSecSecGrpMembHBuff& src )
	: CFSecHPKey(), cflib::ICFLibCloneableObj() {
		requiredClusterId = cfsec::CFSecSecGrpMembBuff::CLUSTERID_INIT_VALUE;
		requiredSecGrpMembId = cfsec::CFSecSecGrpMembBuff::SECGRPMEMBID_INIT_VALUE;
		requiredSecGroupId = cfsec::CFSecSecGrpMembBuff::SECGROUPID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFSecSecGrpMembHBuff::clone() {
		CFSecSecGrpMembHBuff* copy = new CFSecSecGrpMembHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFSecSecGrpMembHBuff::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFSecSecGrpMembHBuff::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFSecSecGrpMembHBuff::setRequiredClusterId( const int64_t value ) {
	...
	const int64_t CFSecSecGrpMembHBuff::getRequiredSecGrpMembId() const {
		return( requiredSecGrpMembId );
	}

	const int64_t* CFSecSecGrpMembHBuff::getRequiredSecGrpMembIdReference() const {
		return( &requiredSecGrpMembId );
	}

	void CFSecSecGrpMembHBuff::setRequiredSecGrpMembId( const int64_t value ) {
	...
	const int32_t CFSecSecGrpMembHBuff::getRequiredSecGroupId() const {
		return( requiredSecGroupId );
	}

	const int32_t* CFSecSecGrpMembHBuff::getRequiredSecGroupIdReference() const {
		return( &requiredSecGroupId );
	}

	void CFSecSecGrpMembHBuff::setRequiredSecGroupId( const int32_t value ) {
	...
	const uuid_ptr_t CFSecSecGrpMembHBuff::getRequiredSecUserId() const {
		return( requiredSecUserId );
	}

	const uuid_ptr_t CFSecSecGrpMembHBuff::getRequiredSecUserIdReference() const {
		return( requiredSecUserId );
	}

	void CFSecSecGrpMembHBuff::setRequiredSecUserId( const uuid_ptr_t value ) {
		uuid_copy( requiredSecUserId, value );
	}

	void CFSecSecGrpMembHBuff::generateRequiredSecUserId() {
		uuid_generate_random( requiredSecUserId );
	}

	size_t CFSecSecGrpMembHBuff::hashCode() const {
	...
	CFSecSecGrpMembHBuff CFSecSecGrpMembHBuff::operator =( cfsec::CFSecSecGrpMembBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecGrpMembId( src.getRequiredSecGrpMembId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredSecGroupId( src.getRequiredSecGroupId() );
	...
	CFSecSecGrpMembHBuff CFSecSecGrpMembHBuff::operator =( cfsec::CFSecSecGrpMembHBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecGrpMembId( src.getRequiredSecGrpMembId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredSecGroupId( src.getRequiredSecGroupId() );
	...
	bool CFSecSecGrpMembHBuff::operator <( const CFSecSecGrpMembByClusterIdxKey& rhs ) {
	...
	bool CFSecSecGrpMembHBuff::operator <( const CFSecSecGrpMembByGroupIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecGrpMembHBuff::operator <( const CFSecSecGrpMembByUserIdxKey& rhs ) {
	...
	bool CFSecSecGrpMembHBuff::operator <( const CFSecSecGrpMembByUUserIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecGrpMembHBuff::operator <( const CFSecSecGrpMembPKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecGrpMembHBuff::operator <( const CFSecSecGrpMembHPKey& rhs ) {
	...
	bool CFSecSecGrpMembHBuff::operator <( const CFSecSecGrpMembHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecSecGrpMembHBuff::operator <( const CFSecSecGrpMembBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	std::string CFSecSecGrpMembHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFSecSecGrpMembHBuff" );
