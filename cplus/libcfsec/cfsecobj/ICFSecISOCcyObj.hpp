...
// Description: C++18 Object interface for CFSec ISOCcy.
...
namespace cfsec {
	...
	public:
		...
		virtual cfsec::ICFSecISOCcyObj* realize() = 0;

		virtual cfsec::ICFSecISOCcyObj* read( bool forceRead = false ) = 0;

		virtual cfsec::ICFSecISOCcyEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfsec::ICFSecISOCcyEditObj* getEdit() = 0;

		virtual cfsec::ICFSecISOCcyEditObj* getISOCcyEdit() = 0;

		virtual cfsec::ICFSecISOCcyTableObj* getISOCcyTable() = 0;

		virtual cfsec::ICFSecSchemaObj* getSchema() = 0;

		virtual cfsec::CFSecISOCcyBuff* getBuff() = 0;
		virtual void setBuff( cfsec::CFSecISOCcyBuff* value ) = 0;
		...
		virtual cfsec::CFSecISOCcyPKey* getPKey() = 0;
		virtual void setPKey( cfsec::CFSecISOCcyPKey* value ) = 0;
		...
		virtual std::vector<cfsec::ICFSecISOCtryCcyObj*> getOptionalChildrenCtry( bool forceRead = false ) = 0;
