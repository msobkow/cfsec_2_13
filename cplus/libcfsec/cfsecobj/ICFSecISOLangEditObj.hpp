...
// Description: C++18 Instance Edit Object interface for CFSec ISOLang.
...
namespace cfsec {
	...
	class ICFSecISOLangEditObj
	: public virtual cfsec::ICFSecISOLangObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFSecISOLangEditObj();
		virtual ~ICFSecISOLangEditObj();
		...
		virtual cfsec::ICFSecISOLangObj* getOrig() = 0;

		virtual cfsec::ICFSecISOLangObj* getOrigAsISOLang() = 0;
		...
		virtual cfsec::ICFSecISOLangObj* create() = 0;

		virtual cfsec::ICFSecISOLangEditObj* update() = 0;

		virtual cfsec::ICFSecISOLangEditObj* deleteInstance() = 0;

		virtual const std::string& getRequiredISO6392Code() = 0;
		virtual const std::string* getRequiredISO6392CodeReference() = 0;
		virtual void setRequiredISO6392Code( const std::string& value ) = 0;
		...
		virtual void setOptionalISO6391CodeNull() = 0;
		virtual void setOptionalISO6391CodeValue( const std::string& value ) = 0;

		virtual const std::string& getRequiredEnglishName() = 0;
		virtual const std::string* getRequiredEnglishNameReference() = 0;
		virtual void setRequiredEnglishName( const std::string& value ) = 0;
