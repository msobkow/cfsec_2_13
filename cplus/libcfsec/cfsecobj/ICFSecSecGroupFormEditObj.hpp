...
// Description: C++18 Instance Edit Object interface for CFSec SecGroupForm.
...
namespace cfsec {
	...
	class ICFSecSecGroupFormEditObj
	: public virtual cfsec::ICFSecSecGroupFormObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFSecSecGroupFormEditObj();
		virtual ~ICFSecSecGroupFormEditObj();
		...
		virtual cfsec::ICFSecSecGroupFormObj* getOrig() = 0;

		virtual cfsec::ICFSecSecGroupFormObj* getOrigAsSecGroupForm() = 0;
		...
		virtual cfsec::ICFSecSecGroupFormObj* create() = 0;

		virtual cfsec::ICFSecSecGroupFormEditObj* update() = 0;

		virtual cfsec::ICFSecSecGroupFormEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredParentApp( cfsec::ICFSecSecAppObj* value ) = 0;

		virtual cfsec::ICFSecSecFormObj* getRequiredParentForm( bool forceRead = false ) = 0;
		virtual void setRequiredParentForm( cfsec::ICFSecSecFormObj* value ) = 0;
