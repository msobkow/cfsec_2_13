...
// Description: C++18 Instance Edit Object interface for CFSec Cluster.
...
namespace cfsec {
	...
	class ICFSecClusterEditObj
	: public virtual cfsec::ICFSecClusterObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFSecClusterEditObj();
		virtual ~ICFSecClusterEditObj();
		...
		virtual cfsec::ICFSecClusterObj* getOrig() = 0;

		virtual cfsec::ICFSecClusterObj* getOrigAsCluster() = 0;
		...
		virtual cfsec::ICFSecClusterObj* create() = 0;

		virtual cfsec::ICFSecClusterEditObj* update() = 0;

		virtual cfsec::ICFSecClusterEditObj* deleteInstance() = 0;
