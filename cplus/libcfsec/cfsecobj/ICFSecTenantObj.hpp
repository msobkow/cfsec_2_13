...
// Description: C++18 Object interface for CFSec Tenant.
...
namespace cfsec {
	...
	public:
		...
		virtual cfsec::ICFSecTenantObj* realize() = 0;

		virtual cfsec::ICFSecTenantObj* read( bool forceRead = false ) = 0;

		virtual cfsec::ICFSecTenantEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfsec::ICFSecTenantEditObj* getEdit() = 0;

		virtual cfsec::ICFSecTenantEditObj* getTenantEdit() = 0;

		virtual cfsec::ICFSecTenantTableObj* getTenantTable() = 0;

		virtual cfsec::ICFSecSchemaObj* getSchema() = 0;

		virtual cfsec::CFSecTenantBuff* getBuff() = 0;
		virtual void setBuff( cfsec::CFSecTenantBuff* value ) = 0;

		inline cfsec::CFSecTenantBuff* getTenantBuff() {
			return( static_cast<cfsec::CFSecTenantBuff*>( getBuff() ) );
		};

		inline cfsec::CFSecTenantBuff* getTenantEditBuff() {
			return( dynamic_cast<cfsec::CFSecTenantBuff*>( getBuff() ) );
		};

		virtual cfsec::CFSecTenantPKey* getPKey() = 0;
		virtual void setPKey( cfsec::CFSecTenantPKey* value ) = 0;
		...
		virtual std::vector<cfsec::ICFSecTSecGroupObj*> getOptionalComponentsTSecGroup( bool forceRead = false ) = 0;
