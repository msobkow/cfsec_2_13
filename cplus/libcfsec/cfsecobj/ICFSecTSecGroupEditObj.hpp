...
// Description: C++18 Instance Edit Object interface for CFSec TSecGroup.
...
namespace cfsec {
	...
	class ICFSecTSecGroupEditObj
	: public virtual cfsec::ICFSecTSecGroupObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFSecTSecGroupEditObj();
		virtual ~ICFSecTSecGroupEditObj();
		...
		virtual cfsec::ICFSecTSecGroupObj* getOrig() = 0;

		virtual cfsec::ICFSecTSecGroupObj* getOrigAsTSecGroup() = 0;
		...
		virtual cfsec::ICFSecTSecGroupObj* create() = 0;

		virtual cfsec::ICFSecTSecGroupEditObj* update() = 0;

		virtual cfsec::ICFSecTSecGroupEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredContainerTenant( cfsec::ICFSecTenantObj* value ) = 0;
