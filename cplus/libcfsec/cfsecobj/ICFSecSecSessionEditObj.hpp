...
// Description: C++18 Instance Edit Object interface for CFSec SecSession.
...
namespace cfsec {
	...
	class ICFSecSecSessionEditObj
	: public virtual cfsec::ICFSecSecSessionObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFSecSecSessionEditObj();
		virtual ~ICFSecSecSessionEditObj();
		...
		virtual cfsec::ICFSecSecSessionObj* getOrig() = 0;

		virtual cfsec::ICFSecSecSessionObj* getOrigAsSecSession() = 0;
		...
		virtual cfsec::ICFSecSecSessionObj* create() = 0;

		virtual cfsec::ICFSecSecSessionEditObj* update() = 0;

		virtual cfsec::ICFSecSecSessionEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredContainerSecUser( cfsec::ICFSecSecUserObj* value ) = 0;

		virtual cfsec::ICFSecSecUserObj* getRequiredParentSecProxy( bool forceRead = false ) = 0;
		virtual void setRequiredParentSecProxy( cfsec::ICFSecSecUserObj* value ) = 0;
