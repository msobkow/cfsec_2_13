...
// Description: C++18 Object interface for CFSec HostNode.
...
namespace cfsec {
	...
	public:
		...
		virtual cfsec::ICFSecHostNodeObj* realize() = 0;

		virtual cfsec::ICFSecHostNodeObj* read( bool forceRead = false ) = 0;

		virtual cfsec::ICFSecHostNodeEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfsec::ICFSecHostNodeEditObj* getEdit() = 0;

		virtual cfsec::ICFSecHostNodeEditObj* getHostNodeEdit() = 0;

		virtual cfsec::ICFSecHostNodeTableObj* getHostNodeTable() = 0;

		virtual cfsec::ICFSecSchemaObj* getSchema() = 0;

		virtual cfsec::CFSecHostNodeBuff* getBuff() = 0;
		virtual void setBuff( cfsec::CFSecHostNodeBuff* value ) = 0;

		inline cfsec::CFSecHostNodeBuff* getHostNodeBuff() {
			return( static_cast<cfsec::CFSecHostNodeBuff*>( getBuff() ) );
		};

		inline cfsec::CFSecHostNodeBuff* getHostNodeEditBuff() {
			return( dynamic_cast<cfsec::CFSecHostNodeBuff*>( getBuff() ) );
		};

		virtual cfsec::CFSecHostNodePKey* getPKey() = 0;
		virtual void setPKey( cfsec::CFSecHostNodePKey* value ) = 0;
		...
		virtual std::vector<cfsec::ICFSecServiceObj*> getOptionalComponentsService( bool forceRead = false ) = 0;
