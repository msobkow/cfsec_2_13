...
// Description: C++18 Instance Edit Object interface for CFSec SecApp.
...
namespace cfsec {
	...
	class ICFSecSecAppEditObj
	: public virtual cfsec::ICFSecSecAppObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFSecSecAppEditObj();
		virtual ~ICFSecSecAppEditObj();
		...
		virtual cfsec::ICFSecSecAppObj* getOrig() = 0;

		virtual cfsec::ICFSecSecAppObj* getOrigAsSecApp() = 0;
		...
		virtual cfsec::ICFSecSecAppObj* create() = 0;

		virtual cfsec::ICFSecSecAppEditObj* update() = 0;

		virtual cfsec::ICFSecSecAppEditObj* deleteInstance() = 0;
