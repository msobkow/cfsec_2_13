...
// Description: C++18 Instance Edit Object interface for CFSec HostNode.
...
namespace cfsec {
	...
	public:
		...
		virtual cfsec::ICFSecHostNodeObj* getOrig() = 0;

		virtual cfsec::ICFSecHostNodeObj* getOrigAsHostNode() = 0;
		...
		virtual cfsec::ICFSecHostNodeObj* create() = 0;

		virtual cfsec::ICFSecHostNodeEditObj* update() = 0;

		virtual cfsec::ICFSecHostNodeEditObj* deleteInstance() = 0;
