...
// Description: C++18 Instance Edit Object interface for CFSec SecDevice.
...
namespace cfsec {
	...
	class ICFSecSecDeviceEditObj
	: public virtual cfsec::ICFSecSecDeviceObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFSecSecDeviceEditObj();
		virtual ~ICFSecSecDeviceEditObj();
		...
		virtual cfsec::ICFSecSecDeviceObj* getOrig() = 0;

		virtual cfsec::ICFSecSecDeviceObj* getOrigAsSecDevice() = 0;
		...
		virtual cfsec::ICFSecSecDeviceObj* create() = 0;

		virtual cfsec::ICFSecSecDeviceEditObj* update() = 0;

		virtual cfsec::ICFSecSecDeviceEditObj* deleteInstance() = 0;
