...
// Description: C++18 base object instance specification for CFSec HostNode.
...
namespace cfsec {
	...
	class CFSecHostNodeObj
	: public virtual ICFSecHostNodeObj
	{
	protected:
	...
	public:
		...
		CFSecHostNodeObj();
		CFSecHostNodeObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFSecHostNodeObj();
