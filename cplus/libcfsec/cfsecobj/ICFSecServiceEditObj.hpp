...
// Description: C++18 Instance Edit Object interface for CFSec Service.
...
namespace cfsec {
	...
	class ICFSecServiceEditObj
	: public virtual cfsec::ICFSecServiceObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFSecServiceEditObj();
		virtual ~ICFSecServiceEditObj();
		...
		virtual cfsec::ICFSecServiceObj* getOrig() = 0;

		virtual cfsec::ICFSecServiceObj* getOrigAsService() = 0;
		...
		virtual cfsec::ICFSecServiceObj* create() = 0;

		virtual cfsec::ICFSecServiceEditObj* update() = 0;

		virtual cfsec::ICFSecServiceEditObj* deleteInstance() = 0;

		virtual const int16_t getRequiredHostPort() = 0;
		virtual const int16_t* getRequiredHostPortReference() = 0;
		virtual void setRequiredHostPort( const int16_t value ) = 0;
		...
		virtual void setOptionalContainerHost( cfsec::ICFSecHostNodeObj* value ) = 0;

		virtual cfsec::ICFSecServiceTypeObj* getOptionalParentServiceType( bool forceRead = false ) = 0;
		virtual void setOptionalParentServiceType( cfsec::ICFSecServiceTypeObj* value ) = 0;
