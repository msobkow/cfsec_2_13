...
// Description: C++18 Instance Edit Object interface for CFSec ISOCtryLang.
...
namespace cfsec {
	...
	class ICFSecISOCtryLangEditObj
	: public virtual cfsec::ICFSecISOCtryLangObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFSecISOCtryLangEditObj();
		virtual ~ICFSecISOCtryLangEditObj();
		...
		virtual cfsec::ICFSecISOCtryLangObj* getOrig() = 0;

		virtual cfsec::ICFSecISOCtryLangObj* getOrigAsISOCtryLang() = 0;
		...
		virtual cfsec::ICFSecISOCtryLangObj* create() = 0;

		virtual cfsec::ICFSecISOCtryLangEditObj* update() = 0;

		virtual cfsec::ICFSecISOCtryLangEditObj* deleteInstance() = 0;

		virtual cfsec::ICFSecISOCtryObj* getRequiredContainerCtry( bool forceRead = false ) = 0;
		virtual void setRequiredContainerCtry( cfsec::ICFSecISOCtryObj* value ) = 0;

		virtual cfsec::ICFSecISOLangObj* getRequiredParentLang( bool forceRead = false ) = 0;
		virtual void setRequiredParentLang( cfsec::ICFSecISOLangObj* value ) = 0;
