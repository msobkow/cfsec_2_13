...
// Description: C++18 Object interface for CFSec TSecGrpInc.
...
namespace cfsec {
	...
	public:
		...
		virtual cfsec::ICFSecTSecGrpIncObj* realize() = 0;

		virtual cfsec::ICFSecTSecGrpIncObj* read( bool forceRead = false ) = 0;

		virtual cfsec::ICFSecTSecGrpIncEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfsec::ICFSecTSecGrpIncEditObj* getEdit() = 0;

		virtual cfsec::ICFSecTSecGrpIncEditObj* getTSecGrpIncEdit() = 0;

		virtual cfsec::ICFSecTSecGrpIncTableObj* getTSecGrpIncTable() = 0;

		virtual cfsec::ICFSecSchemaObj* getSchema() = 0;

		virtual cfsec::CFSecTSecGrpIncBuff* getBuff() = 0;
		virtual void setBuff( cfsec::CFSecTSecGrpIncBuff* value ) = 0;
		...
		virtual cfsec::CFSecTSecGrpIncPKey* getPKey() = 0;
		virtual void setPKey( cfsec::CFSecTSecGrpIncPKey* value ) = 0;
