...
// Description: C++18 Object interface for CFSec ServiceType.
...
namespace cfsec {
	...
	public:
		...
		virtual cfsec::ICFSecServiceTypeObj* realize() = 0;

		virtual cfsec::ICFSecServiceTypeObj* read( bool forceRead = false ) = 0;

		virtual cfsec::ICFSecServiceTypeEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfsec::ICFSecServiceTypeEditObj* getEdit() = 0;

		virtual cfsec::ICFSecServiceTypeEditObj* getServiceTypeEdit() = 0;

		virtual cfsec::ICFSecServiceTypeTableObj* getServiceTypeTable() = 0;

		virtual cfsec::ICFSecSchemaObj* getSchema() = 0;

		virtual cfsec::CFSecServiceTypeBuff* getBuff() = 0;
		virtual void setBuff( cfsec::CFSecServiceTypeBuff* value ) = 0;
		...
		virtual cfsec::CFSecServiceTypePKey* getPKey() = 0;
		virtual void setPKey( cfsec::CFSecServiceTypePKey* value ) = 0;
		...
		virtual std::vector<cfsec::ICFSecServiceObj*> getOptionalChildrenDeployed( bool forceRead = false ) = 0;
