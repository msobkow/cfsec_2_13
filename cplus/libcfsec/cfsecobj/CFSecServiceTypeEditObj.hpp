...
// Description: C++18 edit object instance specification for CFSec ServiceType.
...
namespace cfsec {
	...
	class CFSecServiceTypeEditObj
	: public virtual ICFSecServiceTypeEditObj
	{
	public:
	...
	public:
		CFSecServiceTypeEditObj( cfsec::ICFSecServiceTypeObj* argOrig );
		virtual ~CFSecServiceTypeEditObj();
