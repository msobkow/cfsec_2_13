...
// Description: C++18 base object instance specification for CFSec ISOCtryCcy.
...
namespace cfsec {
	...
	class CFSecISOCtryCcyObj
	: public virtual ICFSecISOCtryCcyObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfsec::ICFSecISOCtryCcyEditObj* edit;
	...
	public:
		...
		CFSecISOCtryCcyObj();
		CFSecISOCtryCcyObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFSecISOCtryCcyObj();
		...
		virtual cfsec::ICFSecISOCtryCcyObj* realize();
		...
		virtual cfsec::ICFSecISOCtryCcyEditObj* beginEdit();
