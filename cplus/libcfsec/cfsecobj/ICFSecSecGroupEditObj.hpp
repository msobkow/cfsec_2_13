...
// Description: C++18 Instance Edit Object interface for CFSec SecGroup.
...
namespace cfsec {
	...
	class ICFSecSecGroupEditObj
	: public virtual cfsec::ICFSecSecGroupObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFSecSecGroupEditObj();
		virtual ~ICFSecSecGroupEditObj();
		...
		virtual cfsec::ICFSecSecGroupObj* getOrig() = 0;

		virtual cfsec::ICFSecSecGroupObj* getOrigAsSecGroup() = 0;
		...
		virtual cfsec::ICFSecSecGroupObj* create() = 0;

		virtual cfsec::ICFSecSecGroupEditObj* update() = 0;

		virtual cfsec::ICFSecSecGroupEditObj* deleteInstance() = 0;
