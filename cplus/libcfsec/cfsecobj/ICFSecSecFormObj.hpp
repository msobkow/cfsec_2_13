...
// Description: C++18 Object interface for CFSec SecForm.
...
namespace cfsec {
	...
	public:
		...
		virtual cfsec::ICFSecSecFormObj* realize() = 0;

		virtual cfsec::ICFSecSecFormObj* read( bool forceRead = false ) = 0;

		virtual cfsec::ICFSecSecFormEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfsec::ICFSecSecFormEditObj* getEdit() = 0;

		virtual cfsec::ICFSecSecFormEditObj* getSecFormEdit() = 0;

		virtual cfsec::ICFSecSecFormTableObj* getSecFormTable() = 0;

		virtual cfsec::ICFSecSchemaObj* getSchema() = 0;

		virtual cfsec::CFSecSecFormBuff* getBuff() = 0;
		virtual void setBuff( cfsec::CFSecSecFormBuff* value ) = 0;
		...
		virtual cfsec::CFSecSecFormPKey* getPKey() = 0;
		virtual void setPKey( cfsec::CFSecSecFormPKey* value ) = 0;
