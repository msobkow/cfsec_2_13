...
// Description: C++18 base object instance specification for CFSec TSecGroup.
...
namespace cfsec {
	...
	class CFSecTSecGroupObj
	: public virtual ICFSecTSecGroupObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfsec::ICFSecTSecGroupEditObj* edit;
	...
	public:
		...
		CFSecTSecGroupObj();
		CFSecTSecGroupObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFSecTSecGroupObj();
		...
		virtual cfsec::ICFSecTSecGroupObj* realize();
		...
		virtual cfsec::ICFSecTSecGroupEditObj* beginEdit();
