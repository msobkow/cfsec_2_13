...
namespace cfsec {
	const std::string CFSecTSecGrpMembByUUserIdxKey::CLASS_NAME( "CFSecTSecGrpMembByUUserIdxKey" );
	const std::string CFSecTSecGrpMembByUUserIdxKey::S_VALUE( "value" );
	const std::string CFSecTSecGrpMembByUUserIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFSecTSecGrpMembByUUserIdxKey::CFSecTSecGrpMembByUUserIdxKey() {
	...
	CFSecTSecGrpMembByUUserIdxKey::CFSecTSecGrpMembByUUserIdxKey( const CFSecTSecGrpMembByUUserIdxKey& src ) {
		requiredTenantId = cfsec::CFSecTSecGrpMembBuff::TENANTID_INIT_VALUE;
		requiredTSecGroupId = cfsec::CFSecTSecGrpMembBuff::TSECGROUPID_INIT_VALUE;
		for( int i = 0; i < 16; i ++ ) {
			requiredSecUserId[i] = 0;
	...
	const int64_t CFSecTSecGrpMembByUUserIdxKey::getRequiredTenantId() const {
		return( requiredTenantId );
	}

	const int64_t* CFSecTSecGrpMembByUUserIdxKey::getRequiredTenantIdReference() const {
		return( &requiredTenantId );
	}

	void CFSecTSecGrpMembByUUserIdxKey::setRequiredTenantId( const int64_t value ) {
	...
	const int32_t CFSecTSecGrpMembByUUserIdxKey::getRequiredTSecGroupId() const {
		return( requiredTSecGroupId );
	}

	const int32_t* CFSecTSecGrpMembByUUserIdxKey::getRequiredTSecGroupIdReference() const {
		return( &requiredTSecGroupId );
	}

	void CFSecTSecGrpMembByUUserIdxKey::setRequiredTSecGroupId( const int32_t value ) {
	...
	const uuid_ptr_t CFSecTSecGrpMembByUUserIdxKey::getRequiredSecUserId() const {
		return( requiredSecUserId );
	}

	const uuid_ptr_t CFSecTSecGrpMembByUUserIdxKey::getRequiredSecUserIdReference() const {
		return( requiredSecUserId );
	}

	void CFSecTSecGrpMembByUUserIdxKey::setRequiredSecUserId( const uuid_ptr_t value ) {
		uuid_copy( requiredSecUserId, value );
	}

	void CFSecTSecGrpMembByUUserIdxKey::generateRequiredSecUserId() {
		uuid_generate_random( requiredSecUserId );
	}

	size_t CFSecTSecGrpMembByUUserIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFSecTSecGrpMembByUUserIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFSecTSecGrpMembByUUserIdxKey" );
	...
	bool CFSecTSecGrpMembByUUserIdxKey::operator <( const CFSecTSecGrpMembByUUserIdxKey& rhs ) {
	...
	bool CFSecTSecGrpMembByUUserIdxKey::operator <( const CFSecTSecGrpMembHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFSecTSecGrpMembByUUserIdxKey::operator <( const CFSecTSecGrpMembBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	CFSecTSecGrpMembByUUserIdxKey CFSecTSecGrpMembByUUserIdxKey::operator =( cfsec::CFSecTSecGrpMembByUUserIdxKey& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredTSecGroupId( src.getRequiredTSecGroupId() );
		setRequiredSecUserId( src.getRequiredSecUserId() );
		return( *this );
	...
	CFSecTSecGrpMembByUUserIdxKey CFSecTSecGrpMembByUUserIdxKey::operator =( cfsec::CFSecTSecGrpMembBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredTSecGroupId( src.getRequiredTSecGroupId() );
		setRequiredSecUserId( src.getRequiredSecUserId() );
		return( *this );
	...
	CFSecTSecGrpMembByUUserIdxKey CFSecTSecGrpMembByUUserIdxKey::operator =( cfsec::CFSecTSecGrpMembHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredTSecGroupId( src.getRequiredTSecGroupId() );
		setRequiredSecUserId( src.getRequiredSecUserId() );
		return( *this );
