// Description: C++18 implementation of a SecApp history primary key object.
...
namespace cfsec {
	...
	const std::string CFSecSecAppHPKey::CLASS_NAME( "CFSecSecAppHPKey" );
	const std::string CFSecSecAppHPKey::S_VALUE( "value" );

	CFSecSecAppHPKey::CFSecSecAppHPKey()
	: CFSecHPKey()
	{
	...
	CFSecSecAppHPKey::CFSecSecAppHPKey( const CFSecSecAppHPKey& src )
	: CFSecHPKey()
	{
		requiredClusterId = cfsec::CFSecSecAppBuff::CLUSTERID_INIT_VALUE;
		requiredSecAppId = cfsec::CFSecSecAppBuff::SECAPPID_INIT_VALUE;
	...
	const int64_t CFSecSecAppHPKey::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFSecSecAppHPKey::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFSecSecAppHPKey::setRequiredClusterId( const int64_t value ) {
	...
	const int32_t CFSecSecAppHPKey::getRequiredSecAppId() const {
		return( requiredSecAppId );
	}

	const int32_t* CFSecSecAppHPKey::getRequiredSecAppIdReference() const {
		return( &requiredSecAppId );
	}

	void CFSecSecAppHPKey::setRequiredSecAppId( const int32_t value ) {
	...
	size_t CFSecSecAppHPKey::hashCode() const {
	...
	std::string CFSecSecAppHPKey::toString() {
	...
	bool CFSecSecAppHPKey::operator <( const CFSecSecAppPKey& rhs ) {
	...
	bool CFSecSecAppHPKey::operator <( const CFSecSecAppHPKey& rhs ) {
	...
	bool CFSecSecAppHPKey::operator <( const CFSecSecAppHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecSecAppHPKey::operator <( const CFSecSecAppBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	CFSecSecAppHPKey CFSecSecAppHPKey::operator =( cfsec::CFSecSecAppPKey& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecAppId( src.getRequiredSecAppId() );
		return( *this );
	}

	CFSecSecAppHPKey CFSecSecAppHPKey::operator =( cfsec::CFSecSecAppHPKey& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecAppId( src.getRequiredSecAppId() );
		return( *this );
	}

	CFSecSecAppHPKey CFSecSecAppHPKey::operator =( cfsec::CFSecSecAppBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecAppId( src.getRequiredSecAppId() );
		return( *this );
	}

	CFSecSecAppHPKey CFSecSecAppHPKey::operator =( cfsec::CFSecSecAppHBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecAppId( src.getRequiredSecAppId() );
		return( *this );
	}
