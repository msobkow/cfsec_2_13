// Description: C++18 implementation of a SecForm history primary key object.
...
namespace cfsec {
	...
	const std::string CFSecSecFormHPKey::CLASS_NAME( "CFSecSecFormHPKey" );
	const std::string CFSecSecFormHPKey::S_VALUE( "value" );

	CFSecSecFormHPKey::CFSecSecFormHPKey()
	: CFSecHPKey()
	{
	...
	CFSecSecFormHPKey::CFSecSecFormHPKey( const CFSecSecFormHPKey& src )
	: CFSecHPKey()
	{
		requiredClusterId = cfsec::CFSecSecFormBuff::CLUSTERID_INIT_VALUE;
		requiredSecFormId = cfsec::CFSecSecFormBuff::SECFORMID_INIT_VALUE;
	...
	const int64_t CFSecSecFormHPKey::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFSecSecFormHPKey::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFSecSecFormHPKey::setRequiredClusterId( const int64_t value ) {
	...
	const int32_t CFSecSecFormHPKey::getRequiredSecFormId() const {
		return( requiredSecFormId );
	}

	const int32_t* CFSecSecFormHPKey::getRequiredSecFormIdReference() const {
		return( &requiredSecFormId );
	}

	void CFSecSecFormHPKey::setRequiredSecFormId( const int32_t value ) {
	...
	size_t CFSecSecFormHPKey::hashCode() const {
	...
	std::string CFSecSecFormHPKey::toString() {
	...
	bool CFSecSecFormHPKey::operator <( const CFSecSecFormPKey& rhs ) {
	...
	bool CFSecSecFormHPKey::operator <( const CFSecSecFormHPKey& rhs ) {
	...
	bool CFSecSecFormHPKey::operator <( const CFSecSecFormHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecSecFormHPKey::operator <( const CFSecSecFormBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	CFSecSecFormHPKey CFSecSecFormHPKey::operator =( cfsec::CFSecSecFormPKey& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecFormId( src.getRequiredSecFormId() );
		return( *this );
	}

	CFSecSecFormHPKey CFSecSecFormHPKey::operator =( cfsec::CFSecSecFormHPKey& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecFormId( src.getRequiredSecFormId() );
		return( *this );
	}

	CFSecSecFormHPKey CFSecSecFormHPKey::operator =( cfsec::CFSecSecFormBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecFormId( src.getRequiredSecFormId() );
		return( *this );
	}

	CFSecSecFormHPKey CFSecSecFormHPKey::operator =( cfsec::CFSecSecFormHBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecFormId( src.getRequiredSecFormId() );
		return( *this );
	}
