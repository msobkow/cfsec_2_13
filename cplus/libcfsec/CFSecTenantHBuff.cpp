// Description: C++18 implementation of a Tenant history buffer object.
...
namespace cfsec {
	...
	const std::string CFSecTenantHBuff::CLASS_NAME( "CFSecTenantHBuff" );
	CFSecTenantHBuff::CFSecTenantHBuff()
	...
	CFSecTenantHBuff::CFSecTenantHBuff( const CFSecTenantHBuff& src )
	: CFSecHPKey(), cflib::ICFLibCloneableObj() {
		requiredClusterId = cfsec::CFSecTenantBuff::CLUSTERID_INIT_VALUE;
		requiredId = cfsec::CFSecTenantBuff::ID_INIT_VALUE;
		requiredTenantName = new std::string( cfsec::CFSecTenantBuff::TENANTNAME_INIT_VALUE );
	...
	cflib::ICFLibCloneableObj* CFSecTenantHBuff::clone() {
		CFSecTenantHBuff* copy = new CFSecTenantHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFSecTenantHBuff::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFSecTenantHBuff::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFSecTenantHBuff::setRequiredClusterId( const int64_t value ) {
	...
	const int64_t CFSecTenantHBuff::getRequiredId() const {
		return( requiredId );
	}

	const int64_t* CFSecTenantHBuff::getRequiredIdReference() const {
		return( &requiredId );
	}

	void CFSecTenantHBuff::setRequiredId( const int64_t value ) {
	...
	const std::string& CFSecTenantHBuff::getRequiredTenantName() const {
		return( *requiredTenantName );
	}

	const std::string* CFSecTenantHBuff::getRequiredTenantNameReference() const {
		return( requiredTenantName );
	}

	void CFSecTenantHBuff::setRequiredTenantName( const std::string& value ) {
	...
	size_t CFSecTenantHBuff::hashCode() const {
	...
	CFSecTenantHBuff CFSecTenantHBuff::operator =( cfsec::CFSecTenantBuff& src ) {
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredTenantName( src.getRequiredTenantName() );
	...
	CFSecTenantHBuff CFSecTenantHBuff::operator =( cfsec::CFSecTenantHBuff& src ) {
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredTenantName( src.getRequiredTenantName() );
	...
	bool CFSecTenantHBuff::operator <( const CFSecTenantByClusterIdxKey& rhs ) {
	...
	bool CFSecTenantHBuff::operator <( const CFSecTenantByUNameIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecTenantHBuff::operator <( const CFSecTenantPKey& rhs ) {
	...
	bool CFSecTenantHBuff::operator <( const CFSecTenantHPKey& rhs ) {
	...
	bool CFSecTenantHBuff::operator <( const CFSecTenantHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecTenantHBuff::operator <( const CFSecTenantBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	std::string CFSecTenantHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFSecTenantHBuff" );
