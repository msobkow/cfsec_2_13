// Description: C++18 implementation of a SecGrpInc history buffer object.
...
namespace cfsec {
	...
	const std::string CFSecSecGrpIncHBuff::CLASS_NAME( "CFSecSecGrpIncHBuff" );
	CFSecSecGrpIncHBuff::CFSecSecGrpIncHBuff()
	...
	CFSecSecGrpIncHBuff::CFSecSecGrpIncHBuff( const CFSecSecGrpIncHBuff& src )
	: CFSecHPKey(), cflib::ICFLibCloneableObj() {
		requiredClusterId = cfsec::CFSecSecGrpIncBuff::CLUSTERID_INIT_VALUE;
		requiredSecGrpIncId = cfsec::CFSecSecGrpIncBuff::SECGRPINCID_INIT_VALUE;
		requiredSecGroupId = cfsec::CFSecSecGrpIncBuff::SECGROUPID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFSecSecGrpIncHBuff::clone() {
		CFSecSecGrpIncHBuff* copy = new CFSecSecGrpIncHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFSecSecGrpIncHBuff::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFSecSecGrpIncHBuff::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFSecSecGrpIncHBuff::setRequiredClusterId( const int64_t value ) {
	...
	const int64_t CFSecSecGrpIncHBuff::getRequiredSecGrpIncId() const {
		return( requiredSecGrpIncId );
	}

	const int64_t* CFSecSecGrpIncHBuff::getRequiredSecGrpIncIdReference() const {
		return( &requiredSecGrpIncId );
	}

	void CFSecSecGrpIncHBuff::setRequiredSecGrpIncId( const int64_t value ) {
	...
	const int32_t CFSecSecGrpIncHBuff::getRequiredSecGroupId() const {
		return( requiredSecGroupId );
	}

	const int32_t* CFSecSecGrpIncHBuff::getRequiredSecGroupIdReference() const {
		return( &requiredSecGroupId );
	}

	void CFSecSecGrpIncHBuff::setRequiredSecGroupId( const int32_t value ) {
	...
	const int32_t CFSecSecGrpIncHBuff::getRequiredIncludeGroupId() const {
		return( requiredIncludeGroupId );
	}

	const int32_t* CFSecSecGrpIncHBuff::getRequiredIncludeGroupIdReference() const {
		return( &requiredIncludeGroupId );
	}

	void CFSecSecGrpIncHBuff::setRequiredIncludeGroupId( const int32_t value ) {
	...
	size_t CFSecSecGrpIncHBuff::hashCode() const {
	...
	CFSecSecGrpIncHBuff CFSecSecGrpIncHBuff::operator =( cfsec::CFSecSecGrpIncBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecGrpIncId( src.getRequiredSecGrpIncId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredSecGroupId( src.getRequiredSecGroupId() );
	...
	CFSecSecGrpIncHBuff CFSecSecGrpIncHBuff::operator =( cfsec::CFSecSecGrpIncHBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecGrpIncId( src.getRequiredSecGrpIncId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredSecGroupId( src.getRequiredSecGroupId() );
	...
	bool CFSecSecGrpIncHBuff::operator <( const CFSecSecGrpIncByClusterIdxKey& rhs ) {
	...
	bool CFSecSecGrpIncHBuff::operator <( const CFSecSecGrpIncByGroupIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecGrpIncHBuff::operator <( const CFSecSecGrpIncByIncludeIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecGrpIncHBuff::operator <( const CFSecSecGrpIncByUIncludeIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecGrpIncHBuff::operator <( const CFSecSecGrpIncPKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecGrpIncHBuff::operator <( const CFSecSecGrpIncHPKey& rhs ) {
	...
	bool CFSecSecGrpIncHBuff::operator <( const CFSecSecGrpIncHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecSecGrpIncHBuff::operator <( const CFSecSecGrpIncBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	std::string CFSecSecGrpIncHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFSecSecGrpIncHBuff" );
