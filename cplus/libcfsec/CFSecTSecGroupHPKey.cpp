// Description: C++18 implementation of a TSecGroup history primary key object.
...
namespace cfsec {
	...
	const std::string CFSecTSecGroupHPKey::CLASS_NAME( "CFSecTSecGroupHPKey" );
	const std::string CFSecTSecGroupHPKey::S_VALUE( "value" );

	CFSecTSecGroupHPKey::CFSecTSecGroupHPKey()
	: CFSecHPKey()
	{
	...
	CFSecTSecGroupHPKey::CFSecTSecGroupHPKey( const CFSecTSecGroupHPKey& src )
	: CFSecHPKey()
	{
		requiredTenantId = cfsec::CFSecTSecGroupBuff::TENANTID_INIT_VALUE;
		requiredTSecGroupId = cfsec::CFSecTSecGroupBuff::TSECGROUPID_INIT_VALUE;
	...
	const int64_t CFSecTSecGroupHPKey::getRequiredTenantId() const {
		return( requiredTenantId );
	}

	const int64_t* CFSecTSecGroupHPKey::getRequiredTenantIdReference() const {
		return( &requiredTenantId );
	}

	void CFSecTSecGroupHPKey::setRequiredTenantId( const int64_t value ) {
	...
	const int32_t CFSecTSecGroupHPKey::getRequiredTSecGroupId() const {
		return( requiredTSecGroupId );
	}

	const int32_t* CFSecTSecGroupHPKey::getRequiredTSecGroupIdReference() const {
		return( &requiredTSecGroupId );
	}

	void CFSecTSecGroupHPKey::setRequiredTSecGroupId( const int32_t value ) {
	...
	size_t CFSecTSecGroupHPKey::hashCode() const {
	...
	std::string CFSecTSecGroupHPKey::toString() {
	...
	bool CFSecTSecGroupHPKey::operator <( const CFSecTSecGroupPKey& rhs ) {
	...
	bool CFSecTSecGroupHPKey::operator <( const CFSecTSecGroupHPKey& rhs ) {
	...
	bool CFSecTSecGroupHPKey::operator <( const CFSecTSecGroupHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecTSecGroupHPKey::operator <( const CFSecTSecGroupBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	CFSecTSecGroupHPKey CFSecTSecGroupHPKey::operator =( cfsec::CFSecTSecGroupPKey& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredTSecGroupId( src.getRequiredTSecGroupId() );
		return( *this );
	}

	CFSecTSecGroupHPKey CFSecTSecGroupHPKey::operator =( cfsec::CFSecTSecGroupHPKey& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredTSecGroupId( src.getRequiredTSecGroupId() );
		return( *this );
	}

	CFSecTSecGroupHPKey CFSecTSecGroupHPKey::operator =( cfsec::CFSecTSecGroupBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredTSecGroupId( src.getRequiredTSecGroupId() );
		return( *this );
	}

	CFSecTSecGroupHPKey CFSecTSecGroupHPKey::operator =( cfsec::CFSecTSecGroupHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredTSecGroupId( src.getRequiredTSecGroupId() );
		return( *this );
	}
