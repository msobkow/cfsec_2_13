// Description: C++18 implementation of a SecApp history buffer object.
...
namespace cfsec {
	...
	const std::string CFSecSecAppHBuff::CLASS_NAME( "CFSecSecAppHBuff" );
	CFSecSecAppHBuff::CFSecSecAppHBuff()
	...
	CFSecSecAppHBuff::CFSecSecAppHBuff( const CFSecSecAppHBuff& src )
	: CFSecHPKey(), cflib::ICFLibCloneableObj() {
		requiredClusterId = cfsec::CFSecSecAppBuff::CLUSTERID_INIT_VALUE;
		requiredSecAppId = cfsec::CFSecSecAppBuff::SECAPPID_INIT_VALUE;
		requiredJEEMountName = new std::string( cfsec::CFSecSecAppBuff::JEEMOUNTNAME_INIT_VALUE );
	...
	cflib::ICFLibCloneableObj* CFSecSecAppHBuff::clone() {
		CFSecSecAppHBuff* copy = new CFSecSecAppHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFSecSecAppHBuff::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFSecSecAppHBuff::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFSecSecAppHBuff::setRequiredClusterId( const int64_t value ) {
	...
	const int32_t CFSecSecAppHBuff::getRequiredSecAppId() const {
		return( requiredSecAppId );
	}

	const int32_t* CFSecSecAppHBuff::getRequiredSecAppIdReference() const {
		return( &requiredSecAppId );
	}

	void CFSecSecAppHBuff::setRequiredSecAppId( const int32_t value ) {
	...
	const std::string& CFSecSecAppHBuff::getRequiredJEEMountName() const {
		return( *requiredJEEMountName );
	}

	const std::string* CFSecSecAppHBuff::getRequiredJEEMountNameReference() const {
		return( requiredJEEMountName );
	}

	void CFSecSecAppHBuff::setRequiredJEEMountName( const std::string& value ) {
	...
	size_t CFSecSecAppHBuff::hashCode() const {
	...
	CFSecSecAppHBuff CFSecSecAppHBuff::operator =( cfsec::CFSecSecAppBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecAppId( src.getRequiredSecAppId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredJEEMountName( src.getRequiredJEEMountName() );
	...
	CFSecSecAppHBuff CFSecSecAppHBuff::operator =( cfsec::CFSecSecAppHBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecAppId( src.getRequiredSecAppId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredJEEMountName( src.getRequiredJEEMountName() );
	...
	bool CFSecSecAppHBuff::operator <( const CFSecSecAppByClusterIdxKey& rhs ) {
	...
	bool CFSecSecAppHBuff::operator <( const CFSecSecAppByUJEEMountIdxKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecAppHBuff::operator <( const CFSecSecAppPKey& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	bool CFSecSecAppHBuff::operator <( const CFSecSecAppHPKey& rhs ) {
	...
	bool CFSecSecAppHBuff::operator <( const CFSecSecAppHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFSecSecAppHBuff::operator <( const CFSecSecAppBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	std::string CFSecSecAppHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFSecSecAppHBuff" );
