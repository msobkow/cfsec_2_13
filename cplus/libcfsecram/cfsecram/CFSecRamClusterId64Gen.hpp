...
namespace cfsec {
	...
	size_t hashCode() const;
		...
		bool operator <( const cfsec::CFSecRamClusterId64Gen& rhs );
		...
		bool operator >( const cfsec::CFSecRamClusterId64Gen& rhs );
		CFSecRamClusterId64Gen operator =( CFSecRamClusterId64Gen& src );
...
namespace std {
	...
	template<> struct hash<cfsec::CFSecRamClusterId64Gen> {
		typedef cfsec::CFSecRamClusterId64Gen argument_type;
