...
namespace cfsec {
	...
	size_t hashCode() const;
		...
		bool operator <( const cfsec::CFSecRamClusterId32Gen& rhs );
		...
		bool operator >( const cfsec::CFSecRamClusterId32Gen& rhs );
		CFSecRamClusterId32Gen operator =( CFSecRamClusterId32Gen& src );
...
namespace std {
	...
	template<> struct hash<cfsec::CFSecRamClusterId32Gen> {
		typedef cfsec::CFSecRamClusterId32Gen argument_type;
