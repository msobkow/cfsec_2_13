...
// Description: C++18 XML SAX2 Element Handler specification for TSecGroup
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderTSecGroupHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderTSecGroupHandler();
