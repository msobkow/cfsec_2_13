...
// Description: C++18 XML SAX2 Element Handler specification for ISOCcy
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderISOCcyHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderISOCcyHandler();
