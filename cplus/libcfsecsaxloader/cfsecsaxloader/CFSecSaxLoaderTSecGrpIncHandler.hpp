...
// Description: C++18 XML SAX2 Element Handler specification for TSecGrpInc
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderTSecGrpIncHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderTSecGrpIncHandler();
