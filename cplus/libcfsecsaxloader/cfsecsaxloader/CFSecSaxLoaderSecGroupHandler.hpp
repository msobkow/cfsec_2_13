...
// Description: C++18 XML SAX2 Element Handler specification for SecGroup
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderSecGroupHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderSecGroupHandler();
