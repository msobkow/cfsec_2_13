...
// Description: C++18 XML SAX2 Element Handler specification for TSecGrpMemb
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderTSecGrpMembHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderTSecGrpMembHandler();
