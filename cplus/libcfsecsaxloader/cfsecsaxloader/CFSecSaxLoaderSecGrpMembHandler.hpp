...
// Description: C++18 XML SAX2 Element Handler specification for SecGrpMemb
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderSecGrpMembHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderSecGrpMembHandler();
