...
// Description: C++18 XML SAX2 Element Handler specification for SecForm
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderSecFormHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderSecFormHandler();
