...
// Description: C++18 XML SAX2 Element Handler specification for ServiceType
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderServiceTypeHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderServiceTypeHandler();
