...
// Description: C++18 XML SAX2 Element Handler specification for HostNode
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderHostNodeHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderHostNodeHandler();
