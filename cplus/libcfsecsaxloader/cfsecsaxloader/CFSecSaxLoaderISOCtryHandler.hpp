...
// Description: C++18 XML SAX2 Element Handler specification for ISOCtry
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderISOCtryHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderISOCtryHandler();
