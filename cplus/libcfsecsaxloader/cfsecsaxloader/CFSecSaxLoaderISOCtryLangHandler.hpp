...
// Description: C++18 XML SAX2 Element Handler specification for ISOCtryLang
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderISOCtryLangHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderISOCtryLangHandler();
