...
// Description: C++18 XML SAX2 Element Handler specification for ISOCtryCcy
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderISOCtryCcyHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderISOCtryCcyHandler();
