...
// Description: C++18 XML SAX2 Element Handler specification for Tenant
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderTenantHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderTenantHandler();
