...
// Description: C++18 XML SAX2 Element Handler specification for ISOTZone
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderISOTZoneHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderISOTZoneHandler();
