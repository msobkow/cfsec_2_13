...
// Description: C++18 XML SAX2 Element Handler specification for Service
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderServiceHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderServiceHandler();
