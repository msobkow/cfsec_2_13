...
// Description: C++18 XML SAX2 Element Handler specification for SecGrpInc
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderSecGrpIncHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderSecGrpIncHandler();
