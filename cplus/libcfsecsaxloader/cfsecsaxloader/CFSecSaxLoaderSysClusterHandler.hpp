...
// Description: C++18 XML SAX2 Element Handler specification for SysCluster
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderSysClusterHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderSysClusterHandler();
