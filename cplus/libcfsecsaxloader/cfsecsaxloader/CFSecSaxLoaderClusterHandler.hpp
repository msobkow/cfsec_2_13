...
// Description: C++18 XML SAX2 Element Handler specification for Cluster
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderClusterHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderClusterHandler();
