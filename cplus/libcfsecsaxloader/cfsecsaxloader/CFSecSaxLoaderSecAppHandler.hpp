...
// Description: C++18 XML SAX2 Element Handler specification for SecApp
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderSecAppHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderSecAppHandler();
