...
// Description: C++18 XML SAX2 Element Handler specification for ISOLang
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderISOLangHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderISOLangHandler();
