...
// Description: C++18 XML SAX2 Element Handler specification for SecUser
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderSecUserHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderSecUserHandler();
