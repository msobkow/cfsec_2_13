...
// Description: C++18 XML SAX2 Element Handler specification for SecDevice
...
namespace cfsec {
	...
	public:
		...
		CFSecSaxLoaderSecDeviceHandler( cfsec::CFSecSaxLoader* saxLoader );
		virtual ~CFSecSaxLoaderSecDeviceHandler();
