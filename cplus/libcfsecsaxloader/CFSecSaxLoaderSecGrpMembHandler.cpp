...
namespace cfsec {
	...
	const std::string CFSecSaxLoaderSecGrpMembHandler::CLASS_NAME( "CFSecSaxLoaderSecGrpMembHandler" );
	const std::string CFSecSaxLoaderSecGrpMembHandler::S_True( "true" );
	const std::string CFSecSaxLoaderSecGrpMembHandler::S_False( "false" );
	const std::string CFSecSaxLoaderSecGrpMembHandler::S_Yes( "yes" );
	const std::string CFSecSaxLoaderSecGrpMembHandler::S_No( "no" );
	const std::string CFSecSaxLoaderSecGrpMembHandler::S_0( "0" );
	const std::string CFSecSaxLoaderSecGrpMembHandler::S_1( "1" );

	CFSecSaxLoaderSecGrpMembHandler::CFSecSaxLoaderSecGrpMembHandler( cfsec::CFSecSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFSecSaxLoaderSecGrpMembHandler::~CFSecSaxLoaderSecGrpMembHandler() {
	}

	void CFSecSaxLoaderSecGrpMembHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			loaderBehaviour = saxLoader->getSecGrpMembLoaderBehaviour();
			origSecGrpMemb = schemaObj->getSecGrpMembTableObj()->readSecGrpMembByUUserIdx( refCluster->getRequiredId(),
			...
			if( origSecGrpMemb == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfsec::CFSecSaxLoader::LoaderBehaviourEnum::Update:
						editSecGrpMemb = dynamic_cast<cfsec::ICFSecSecGrpMembEditObj*>( origSecGrpMemb->beginEdit() );
...
cleanup:
	...
	void CFSecSaxLoaderSecGrpMembHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
