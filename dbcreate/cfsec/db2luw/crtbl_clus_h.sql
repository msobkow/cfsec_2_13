--
--	@(#) dbcreate/cfsec/db2luw/crtbl_clus_h.sql
--
...
CREATE UNIQUE INDEX cfsec213.clus_h_ididx ON cfsec213.clus_h (	\
	auditclusterid,	\
	auditstamp,	\
	Id,	\
	auditaction,	\
