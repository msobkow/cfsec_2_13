--
--	@(#) dbcreate/cfsec/pgsql/crsp_delete_secdev_by_nameidx.pgsql
--
...
--
create or replace function cfsec213.sp_delete_secdev_by_nameidx(
...
begin
	...
	loop
				select cfsec213.sp_delete_secdev( argAuditClusterId,
						argAuditUserId,
						argAuditSessionId,
						secClusterId,
						secTenantId,
