--
--	@(#) dbcreate/cfsec/pgsql/crtbl_iso_ccy_h.pgsql
--
...
--
CREATE TABLE cfsec213.iso_ccy_h (
...
CREATE UNIQUE INDEX iso_ccy_h_ididx ON cfsec213.iso_ccy_h (
	auditclusterid,
	auditstamp,
	isoccyid,
	auditaction,
...
ALTER TABLE cfsec213.iso_ccy_h
	ADD CONSTRAINT pk_iso_ccy_h_ididx PRIMARY KEY ( auditclusterid, auditstamp, isoccyid, auditaction, revision );
