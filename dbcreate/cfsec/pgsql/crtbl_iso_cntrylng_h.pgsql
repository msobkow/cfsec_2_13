--
--	@(#) dbcreate/cfsec/pgsql/crtbl_iso_cntrylng_h.pgsql
--
...
CREATE UNIQUE INDEX iso_cntrylng_h_ididx ON cfsec213.iso_cntrylng_h (
	auditclusterid,
	auditstamp,
	isoctryid,
	isolangid,
...
ALTER TABLE cfsec213.iso_cntrylng_h
	ADD CONSTRAINT pk_iso_cntrylng_h_ididx PRIMARY KEY ( auditclusterid, auditstamp, isoctryid, isolangid, auditaction, revision );
