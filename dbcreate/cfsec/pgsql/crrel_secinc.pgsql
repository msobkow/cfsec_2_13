--
--	@(#) dbcreate/cfsec/pgsql/crrel_secinc.pgsql
--
...
ALTER TABLE cfsec213.SecInc ADD CONSTRAINT chk_secinc_createdby
	FOREIGN KEY ( createdby )
	REFERENCES cfsec213.SecUser ( secuserid )
	ON DELETE RESTRICT;


ALTER TABLE cfsec213.SecInc ADD CONSTRAINT chk_secinc_updatedby
