--
--	@(#) dbcreate/cfsec/pgsql/crrel_secgrpfrm.pgsql
--
...
ALTER TABLE cfsec213.SecGrpFrm ADD CONSTRAINT chk_secgrpfrm_createdby
	FOREIGN KEY ( createdby )
	REFERENCES cfsec213.SecUser ( secuserid )
	ON DELETE RESTRICT;


ALTER TABLE cfsec213.SecGrpFrm ADD CONSTRAINT chk_secgrpfrm_updatedby
