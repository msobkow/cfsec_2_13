--
--	@(#) dbcreate/cfsec/pgsql/crtbl_iso_cntry_h.pgsql
--
...
CREATE UNIQUE INDEX iso_cntry_h_ididx ON cfsec213.iso_cntry_h (
	auditclusterid,
	auditstamp,
	isoctryid,
	auditaction,
...
ALTER TABLE cfsec213.iso_cntry_h
	ADD CONSTRAINT pk_iso_cntry_h_ididx PRIMARY KEY ( auditclusterid, auditstamp, isoctryid, auditaction, revision );
