--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_cntrybyididx.plsql
--
...
create or replace procedure cfsec213.rd_iso_cntrybyididx(
...
show errors procedure cfsec213.rd_iso_cntrybyididx;
