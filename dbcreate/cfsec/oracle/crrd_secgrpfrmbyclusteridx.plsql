--
--	@(#) dbcreate/cfsec/oracle/crrd_secgrpfrmbyclusteridx.plsql
--
...
create or replace procedure cfsec213.rd_secgrpfrmbyclusteridx(
...
show errors procedure cfsec213.rd_secgrpfrmbyclusteridx;
