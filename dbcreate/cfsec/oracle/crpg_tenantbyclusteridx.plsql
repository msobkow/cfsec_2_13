--
--	@(#) dbcreate/cfsec/oracle/crpg_tenantbyclusteridx.plsql
--
...
create or replace procedure cfsec213.pg_tenantbyclusteridx(
...
end pg_tenantbyclusteridx;
/

show errors procedure cfsec213.pg_tenantbyclusteridx;
