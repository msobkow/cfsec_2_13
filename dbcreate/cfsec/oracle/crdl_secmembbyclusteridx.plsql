--
--	@(#) dbcreate/cfsec/oracle/crdl_secmembbyclusteridx.plsql
--
...
create or replace procedure cfsec213.dl_secmembbyclusteridx(
...
show errors procedure cfsec213.dl_secmembbyclusteridx;
