--
--	@(#) dbcreate/cfsec/oracle/crdl_hostsvcbyididx.plsql
--
...
create or replace procedure cfsec213.dl_hostsvcbyididx(
	...
	argServiceId numeric ) authid definer
is
...
show errors procedure cfsec213.dl_hostsvcbyididx;
