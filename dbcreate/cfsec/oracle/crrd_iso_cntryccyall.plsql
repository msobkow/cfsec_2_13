--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_cntryccyall.plsql
--
...
create or replace procedure cfsec213.rd_iso_cntryccyall(
...
show errors procedure cfsec213.rd_iso_cntryccyall;
