--
--	@(#) dbcreate/cfsec/oracle/crdl_secformbysecappidx.plsql
--
...
create or replace procedure cfsec213.dl_secformbysecappidx(
...
show errors procedure cfsec213.dl_secformbysecappidx;
