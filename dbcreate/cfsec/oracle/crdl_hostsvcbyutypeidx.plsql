--
--	@(#) dbcreate/cfsec/oracle/crdl_hostsvcbyutypeidx.plsql
--
...
create or replace procedure cfsec213.dl_hostsvcbyutypeidx(
...
show errors procedure cfsec213.dl_hostsvcbyutypeidx;
