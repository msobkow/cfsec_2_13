--
--	@(#) dbcreate/cfsec/oracle/crpg_secgrpfrmbyclusteridx.plsql
--
...
create or replace procedure cfsec213.pg_secgrpfrmbyclusteridx(
...
show errors procedure cfsec213.pg_secgrpfrmbyclusteridx;
