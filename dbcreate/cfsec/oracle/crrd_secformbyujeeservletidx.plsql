--
--	@(#) dbcreate/cfsec/oracle/crrd_secformbyujeeservletidx.plsql
--
...
create or replace procedure cfsec213.rd_secformbyujeeservletidx(
...
show errors procedure cfsec213.rd_secformbyujeeservletidx;
