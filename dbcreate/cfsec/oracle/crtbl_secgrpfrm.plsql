--
--	@(#) dbcreate/cfsec/oracle/crtbl_secgrpfrm.plsql
--
...
--
CREATE TABLE cfsec213.SecGrpFrm (
...
CREATE UNIQUE INDEX SecGroupForm_pidx ON cfsec213.SecGrpFrm (
	clusid,
	secgrpfrmid ) TABLESPACE cfsec213_idx1;

ALTER TABLE cfsec213.SecGrpFrm
