--
--	@(#) dbcreate/cfsec/oracle/crdl_secsessbystartidx.plsql
--
...
create or replace procedure cfsec213.dl_secsessbystartidx(
...
show errors procedure cfsec213.dl_secsessbystartidx;
