--
--	@(#) dbcreate/cfsec/oracle/crpg_hostsvcall.plsql
--
...
create or replace procedure cfsec213.pg_hostsvcall(
...
begin
	...
	then
		open retCursor for
			...
			where ( ( ( a012.ClusterId = priorClusterId )
...
show errors procedure cfsec213.pg_hostsvcall;
