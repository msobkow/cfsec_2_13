--
--	@(#) dbcreate/cfsec/oracle/crcrt_secinc.plsql
--
...
create or replace procedure cfsec213.crt_secinc(
...
begin
	...
	argSecGrpIncId := cfsec213.nxt_secgrpincidgen( argClusId );
...
show errors procedure cfsec213.crt_secinc;
