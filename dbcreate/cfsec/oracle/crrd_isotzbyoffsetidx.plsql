--
--	@(#) dbcreate/cfsec/oracle/crrd_isotzbyoffsetidx.plsql
--
...
create or replace procedure cfsec213.rd_isotzbyoffsetidx(
	...
	argTZMinOffset smallint ) authid definer
is
begin
...
show errors procedure cfsec213.rd_isotzbyoffsetidx;
