--
--	@(#) dbcreate/cfsec/oracle/crrd_secgrpfrmbygroupidx.plsql
--
...
create or replace procedure cfsec213.rd_secgrpfrmbygroupidx(
...
show errors procedure cfsec213.rd_secgrpfrmbygroupidx;
