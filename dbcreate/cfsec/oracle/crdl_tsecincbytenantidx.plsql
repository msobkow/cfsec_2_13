--
--	@(#) dbcreate/cfsec/oracle/crdl_tsecincbytenantidx.plsql
--
...
create or replace procedure cfsec213.dl_tsecincbytenantidx(
...
show errors procedure cfsec213.dl_tsecincbytenantidx;
