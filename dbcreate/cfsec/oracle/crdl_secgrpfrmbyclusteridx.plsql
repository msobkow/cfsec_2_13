--
--	@(#) dbcreate/cfsec/oracle/crdl_secgrpfrmbyclusteridx.plsql
--
...
create or replace procedure cfsec213.dl_secgrpfrmbyclusteridx(
...
show errors procedure cfsec213.dl_secgrpfrmbyclusteridx;
