--
--	@(#) dbcreate/cfsec/oracle/crpg_hostsvcbyclusteridx.plsql
--
...
create or replace procedure cfsec213.pg_hostsvcbyclusteridx(
...
end pg_hostsvcbyclusteridx;
/

show errors procedure cfsec213.pg_hostsvcbyclusteridx;
