--
--	@(#) dbcreate/cfsec/oracle/crdl_hostsvcbyhostidx.plsql
--
...
create or replace procedure cfsec213.dl_hostsvcbyhostidx(
...
show errors procedure cfsec213.dl_hostsvcbyhostidx;
