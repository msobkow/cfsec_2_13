--
--	@(#) dbcreate/cfsec/oracle/crpg_secsessbyfinishidx.plsql
--
...
create or replace procedure cfsec213.pg_secsessbyfinishidx(
...
show errors procedure cfsec213.pg_secsessbyfinishidx;
