--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_cntrybynameidx.plsql
--
...
create or replace procedure cfsec213.rd_iso_cntrybynameidx(
...
show errors procedure cfsec213.rd_iso_cntrybynameidx;
