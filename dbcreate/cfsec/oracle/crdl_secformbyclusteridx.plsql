--
--	@(#) dbcreate/cfsec/oracle/crdl_secformbyclusteridx.plsql
--
...
create or replace procedure cfsec213.dl_secformbyclusteridx(
...
show errors procedure cfsec213.dl_secformbyclusteridx;
