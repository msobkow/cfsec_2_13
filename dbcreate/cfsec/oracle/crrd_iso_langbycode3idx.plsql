--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_langbycode3idx.plsql
--
...
create or replace procedure cfsec213.rd_iso_langbycode3idx(
...
end rd_iso_langbycode3idx;
/

show errors procedure cfsec213.rd_iso_langbycode3idx;
