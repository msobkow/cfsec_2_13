--
--	@(#) dbcreate/cfsec/oracle/crrd_secformbysecappidx.plsql
--
...
create or replace procedure cfsec213.rd_secformbysecappidx(
...
show errors procedure cfsec213.rd_secformbysecappidx;
