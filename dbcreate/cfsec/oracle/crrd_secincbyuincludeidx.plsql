--
--	@(#) dbcreate/cfsec/oracle/crrd_secincbyuincludeidx.plsql
--
...
create or replace procedure cfsec213.rd_secincbyuincludeidx(
...
show errors procedure cfsec213.rd_secincbyuincludeidx;
