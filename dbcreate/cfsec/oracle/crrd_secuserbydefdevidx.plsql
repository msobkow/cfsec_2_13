--
--	@(#) dbcreate/cfsec/oracle/crrd_secuserbydefdevidx.plsql
--
...
create or replace procedure cfsec213.rd_secuserbydefdevidx(
...
show errors procedure cfsec213.rd_secuserbydefdevidx;
