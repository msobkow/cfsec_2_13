--
--	@(#) dbcreate/cfsec/oracle/crrd_secuserbyuloginidx.plsql
--
...
create or replace procedure cfsec213.rd_secuserbyuloginidx(
	...
	secTenantId numeric,
	arglogin_id varchar2 ) authid definer
is
begin
	...
	where
			a011.login_id = arglogin_id;
end rd_secuserbyuloginidx;
/

show errors procedure cfsec213.rd_secuserbyuloginidx;
