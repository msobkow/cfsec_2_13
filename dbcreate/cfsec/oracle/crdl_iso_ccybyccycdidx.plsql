--
--	@(#) dbcreate/cfsec/oracle/crdl_iso_ccybyccycdidx.plsql
--
...
create or replace procedure cfsec213.dl_iso_ccybyccycdidx(
...
show errors procedure cfsec213.dl_iso_ccybyccycdidx;
