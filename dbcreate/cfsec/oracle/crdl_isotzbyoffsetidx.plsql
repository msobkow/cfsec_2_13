--
--	@(#) dbcreate/cfsec/oracle/crdl_isotzbyoffsetidx.plsql
--
...
create or replace procedure cfsec213.dl_isotzbyoffsetidx(
...
show errors procedure cfsec213.dl_isotzbyoffsetidx;
