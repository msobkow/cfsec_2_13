--
--	@(#) dbcreate/cfsec/oracle/crrd_isotzbyutznameidx.plsql
--
...
create or replace procedure cfsec213.rd_isotzbyutznameidx(
...
show errors procedure cfsec213.rd_isotzbyutznameidx;
