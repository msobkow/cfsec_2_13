--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_cntryccybyccyidx.plsql
--
...
create or replace procedure cfsec213.rd_iso_cntryccybyccyidx(
...
begin
	...
	where
		...
		order by ISOCtryId desc,
			ISOCcyId desc;
end rd_iso_cntryccybyccyidx;
/

show errors procedure cfsec213.rd_iso_cntryccybyccyidx;
