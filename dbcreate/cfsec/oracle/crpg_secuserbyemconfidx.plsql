--
--	@(#) dbcreate/cfsec/oracle/crpg_secuserbyemconfidx.plsql
--
...
create or replace procedure cfsec213.pg_secuserbyemconfidx(
...
end pg_secuserbyemconfidx;
/

show errors procedure cfsec213.pg_secuserbyemconfidx;
