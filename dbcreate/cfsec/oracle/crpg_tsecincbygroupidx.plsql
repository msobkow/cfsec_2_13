--
--	@(#) dbcreate/cfsec/oracle/crpg_tsecincbygroupidx.plsql
--
...
create or replace procedure cfsec213.pg_tsecincbygroupidx(
...
end pg_tsecincbygroupidx;
/

show errors procedure cfsec213.pg_tsecincbygroupidx;
