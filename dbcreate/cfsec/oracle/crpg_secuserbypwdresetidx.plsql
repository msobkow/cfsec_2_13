--
--	@(#) dbcreate/cfsec/oracle/crpg_secuserbypwdresetidx.plsql
--
...
create or replace procedure cfsec213.pg_secuserbypwdresetidx(
...
end pg_secuserbypwdresetidx;
/

show errors procedure cfsec213.pg_secuserbypwdresetidx;
