--
--	@(#) dbcreate/cfsec/oracle/crrd_secincbyclusteridx.plsql
--
...
create or replace procedure cfsec213.rd_secincbyclusteridx(
...
show errors procedure cfsec213.rd_secincbyclusteridx;
