--
--	@(#) dbcreate/cfsec/oracle/crpg_secgrpfrmbygroupidx.plsql
--
...
create or replace procedure cfsec213.pg_secgrpfrmbygroupidx(
...
end pg_secgrpfrmbygroupidx;
/

show errors procedure cfsec213.pg_secgrpfrmbygroupidx;
