--
--	@(#) dbcreate/cfsec/oracle/crdl_sysclusbyclusteridx.plsql
--
...
create or replace procedure cfsec213.dl_sysclusbyclusteridx(
...
show errors procedure cfsec213.dl_sysclusbyclusteridx;
