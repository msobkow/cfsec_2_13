--
--	@(#) dbcreate/cfsec/oracle/crdl_tsecmembbygroupidx.plsql
--
...
create or replace procedure cfsec213.dl_tsecmembbygroupidx(
...
show errors procedure cfsec213.dl_tsecmembbygroupidx;
