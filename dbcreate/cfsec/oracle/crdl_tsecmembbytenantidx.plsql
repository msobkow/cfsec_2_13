--
--	@(#) dbcreate/cfsec/oracle/crdl_tsecmembbytenantidx.plsql
--
...
create or replace procedure cfsec213.dl_tsecmembbytenantidx(
...
show errors procedure cfsec213.dl_tsecmembbytenantidx;
