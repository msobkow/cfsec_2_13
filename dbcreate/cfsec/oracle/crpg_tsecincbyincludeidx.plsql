--
--	@(#) dbcreate/cfsec/oracle/crpg_tsecincbyincludeidx.plsql
--
...
create or replace procedure cfsec213.pg_tsecincbyincludeidx(
...
end pg_tsecincbyincludeidx;
/

show errors procedure cfsec213.pg_tsecincbyincludeidx;
