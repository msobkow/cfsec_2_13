--
--	@(#) dbcreate/cfsec/oracle/crrd_tsecmembbyididx.plsql
--
...
create or replace procedure cfsec213.rd_tsecmembbyididx(
...
show errors procedure cfsec213.rd_tsecmembbyididx;
