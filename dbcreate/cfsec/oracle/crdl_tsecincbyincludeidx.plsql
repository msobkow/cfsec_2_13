--
--	@(#) dbcreate/cfsec/oracle/crdl_tsecincbyincludeidx.plsql
--
...
create or replace procedure cfsec213.dl_tsecincbyincludeidx(
...
show errors procedure cfsec213.dl_tsecincbyincludeidx;
