--
--	@(#) dbcreate/cfsec/oracle/crrd_secmembbyuuseridx.plsql
--
...
create or replace procedure cfsec213.rd_secmembbyuuseridx(
...
show errors procedure cfsec213.rd_secmembbyuuseridx;
