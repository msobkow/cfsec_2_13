--
--	@(#) dbcreate/cfsec/oracle/crdl_iso_cntrylngbyctryidx.plsql
--
...
create or replace procedure cfsec213.dl_iso_cntrylngbyctryidx(
...
show errors procedure cfsec213.dl_iso_cntrylngbyctryidx;
