--
--	@(#) dbcreate/cfsec/oracle/crdl_secsessbysecuseridx.plsql
--
...
create or replace procedure cfsec213.dl_secsessbysecuseridx(
...
show errors procedure cfsec213.dl_secsessbysecuseridx;
