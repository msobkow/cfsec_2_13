--
--	@(#) dbcreate/cfsec/oracle/crrd_secsessbysecdevidx.plsql
--
...
create or replace procedure cfsec213.rd_secsessbysecdevidx(
...
show errors procedure cfsec213.rd_secsessbysecdevidx;
