--
--	@(#) dbcreate/cfsec/oracle/crrd_isotzbyiso8601idx.plsql
--
...
create or replace procedure cfsec213.rd_isotzbyiso8601idx(
...
show errors procedure cfsec213.rd_isotzbyiso8601idx;
