--
--	@(#) dbcreate/cfsec/oracle/crdl_tsecgrpbytenantvisidx.plsql
--
...
create or replace procedure cfsec213.dl_tsecgrpbytenantvisidx(
...
end dl_tsecgrpbytenantvisidx;
/

show errors procedure cfsec213.dl_tsecgrpbytenantvisidx;
