--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_cntrylngall.plsql
--
...
create or replace procedure cfsec213.rd_iso_cntrylngall(
...
show errors procedure cfsec213.rd_iso_cntrylngall;
