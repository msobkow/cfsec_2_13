--
--	@(#) dbcreate/cfsec/oracle/crpg_secuserbydefdevidx.plsql
--
...
create or replace procedure cfsec213.pg_secuserbydefdevidx(
...
end pg_secuserbydefdevidx;
/

show errors procedure cfsec213.pg_secuserbydefdevidx;
