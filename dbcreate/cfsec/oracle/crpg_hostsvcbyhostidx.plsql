--
--	@(#) dbcreate/cfsec/oracle/crpg_hostsvcbyhostidx.plsql
--
...
create or replace procedure cfsec213.pg_hostsvcbyhostidx(
...
show errors procedure cfsec213.pg_hostsvcbyhostidx;
