--
--	@(#) dbcreate/cfsec/oracle/crpg_secmembbygroupidx.plsql
--
...
create or replace procedure cfsec213.pg_secmembbygroupidx(
...
end pg_secmembbygroupidx;
/

show errors procedure cfsec213.pg_secmembbygroupidx;
