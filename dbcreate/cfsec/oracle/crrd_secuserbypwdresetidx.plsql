--
--	@(#) dbcreate/cfsec/oracle/crrd_secuserbypwdresetidx.plsql
--
...
create or replace procedure cfsec213.rd_secuserbypwdresetidx(
...
show errors procedure cfsec213.rd_secuserbypwdresetidx;
