--
--	@(#) dbcreate/cfsec/oracle/crdl_hostsvcbytypeidx.plsql
--
...
create or replace procedure cfsec213.dl_hostsvcbytypeidx(
...
show errors procedure cfsec213.dl_hostsvcbytypeidx;
