--
--	@(#) dbcreate/cfsec/oracle/crrd_secsessbysecuseridx.plsql
--
...
create or replace procedure cfsec213.rd_secsessbysecuseridx(
...
show errors procedure cfsec213.rd_secsessbysecuseridx;
