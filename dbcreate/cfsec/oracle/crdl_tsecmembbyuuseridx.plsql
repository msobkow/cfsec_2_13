--
--	@(#) dbcreate/cfsec/oracle/crdl_tsecmembbyuuseridx.plsql
--
...
create or replace procedure cfsec213.dl_tsecmembbyuuseridx(
...
is
	...
	cursor cursSystem is
		...
		where
			...
			and a018.SecUserId = argSecUserId;
...
show errors procedure cfsec213.dl_tsecmembbyuuseridx;
