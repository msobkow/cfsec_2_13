--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_cntrylngbylangidx.plsql
--
...
create or replace procedure cfsec213.rd_iso_cntrylngbylangidx(
...
begin
	...
	where
		...
		order by ISOCtryId desc,
			ISOLangId desc;
end rd_iso_cntrylngbylangidx;
/

show errors procedure cfsec213.rd_iso_cntrylngbylangidx;
