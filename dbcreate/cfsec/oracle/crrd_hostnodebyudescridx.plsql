--
--	@(#) dbcreate/cfsec/oracle/crrd_hostnodebyudescridx.plsql
--
...
create or replace procedure cfsec213.rd_hostnodebyudescridx(
...
show errors procedure cfsec213.rd_hostnodebyudescridx;
