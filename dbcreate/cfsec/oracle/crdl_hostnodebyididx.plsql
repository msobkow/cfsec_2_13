--
--	@(#) dbcreate/cfsec/oracle/crdl_hostnodebyididx.plsql
--
...
create or replace procedure cfsec213.dl_hostnodebyididx(
...
show errors procedure cfsec213.dl_hostnodebyididx;
