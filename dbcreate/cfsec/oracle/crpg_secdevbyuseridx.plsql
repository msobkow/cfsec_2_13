--
--	@(#) dbcreate/cfsec/oracle/crpg_secdevbyuseridx.plsql
--
...
create or replace procedure cfsec213.pg_secdevbyuseridx(
...
end pg_secdevbyuseridx;
/

show errors procedure cfsec213.pg_secdevbyuseridx;
