--
--	@(#) dbcreate/cfsec/oracle/crpg_secincbygroupidx.plsql
--
...
create or replace procedure cfsec213.pg_secincbygroupidx(
...
show errors procedure cfsec213.pg_secincbygroupidx;
