--
--	@(#) dbcreate/cfsec/oracle/crrd_tsecincbygroupidx.plsql
--
...
create or replace procedure cfsec213.rd_tsecincbygroupidx(
...
show errors procedure cfsec213.rd_tsecincbygroupidx;
