--
--	@(#) dbcreate/cfsec/oracle/crrd_hostsvcbyutypeidx.plsql
--
...
create or replace procedure cfsec213.rd_hostsvcbyutypeidx(
...
show errors procedure cfsec213.rd_hostsvcbyutypeidx;
