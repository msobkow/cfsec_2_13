--
--	@(#) dbcreate/cfsec/oracle/crdl_svctypebyudescridx.plsql
--
...
create or replace procedure cfsec213.dl_svctypebyudescridx(
...
show errors procedure cfsec213.dl_svctypebyudescridx;
