--
--	@(#) dbcreate/cfsec/oracle/crdl_iso_langbyididx.plsql
--
...
create or replace procedure cfsec213.dl_iso_langbyididx(
...
show errors procedure cfsec213.dl_iso_langbyididx;
