--
--	@(#) dbcreate/cfsec/oracle/crrd_tsecgrpall.plsql
--
...
create or replace procedure cfsec213.rd_tsecgrpall(
...
show errors procedure cfsec213.rd_tsecgrpall;
