--
--	@(#) dbcreate/cfsec/oracle/crdl_hostnodebyclusteridx.plsql
--
...
create or replace procedure cfsec213.dl_hostnodebyclusteridx(
...
show errors procedure cfsec213.dl_hostnodebyclusteridx;
