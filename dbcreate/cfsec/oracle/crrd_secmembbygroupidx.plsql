--
--	@(#) dbcreate/cfsec/oracle/crrd_secmembbygroupidx.plsql
--
...
create or replace procedure cfsec213.rd_secmembbygroupidx(
...
show errors procedure cfsec213.rd_secmembbygroupidx;
