--
--	@(#) dbcreate/cfsec/oracle/crdl_tsecmembbyuseridx.plsql
--
...
create or replace procedure cfsec213.dl_tsecmembbyuseridx(
...
show errors procedure cfsec213.dl_tsecmembbyuseridx;
