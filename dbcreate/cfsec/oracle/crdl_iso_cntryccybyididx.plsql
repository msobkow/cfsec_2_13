--
--	@(#) dbcreate/cfsec/oracle/crdl_iso_cntryccybyididx.plsql
--
...
create or replace procedure cfsec213.dl_iso_cntryccybyididx(
...
show errors procedure cfsec213.dl_iso_cntryccybyididx;
