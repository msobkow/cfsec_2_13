--
--	@(#) dbcreate/cfsec/oracle/crpg_secgrpfrmall.plsql
--
...
create or replace procedure cfsec213.pg_secgrpfrmall(
...
begin
	...
	then
		open retCursor for
			...
			where ( ( ( a00d.ClusId = priorClusterId )
...
show errors procedure cfsec213.pg_secgrpfrmall;
