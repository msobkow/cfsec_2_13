--
--	@(#) dbcreate/cfsec/oracle/crrd_secgrpall.plsql
--
...
create or replace procedure cfsec213.rd_secgrpall(
...
show errors procedure cfsec213.rd_secgrpall;
