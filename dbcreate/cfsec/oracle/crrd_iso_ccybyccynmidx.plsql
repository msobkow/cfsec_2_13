--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_ccybyccynmidx.plsql
--
...
create or replace procedure cfsec213.rd_iso_ccybyccynmidx(
...
show errors procedure cfsec213.rd_iso_ccybyccynmidx;
