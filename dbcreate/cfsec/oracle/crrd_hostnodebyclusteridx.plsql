--
--	@(#) dbcreate/cfsec/oracle/crrd_hostnodebyclusteridx.plsql
--
...
create or replace procedure cfsec213.rd_hostnodebyclusteridx(
...
show errors procedure cfsec213.rd_hostnodebyclusteridx;
