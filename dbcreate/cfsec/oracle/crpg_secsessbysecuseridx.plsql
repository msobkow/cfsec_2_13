--
--	@(#) dbcreate/cfsec/oracle/crpg_secsessbysecuseridx.plsql
--
...
create or replace procedure cfsec213.pg_secsessbysecuseridx(
...
end pg_secsessbysecuseridx;
/

show errors procedure cfsec213.pg_secsessbysecuseridx;
