--
--	@(#) dbcreate/cfsec/oracle/crrd_clusbyudescridx.plsql
--
...
create or replace procedure cfsec213.rd_clusbyudescridx(
...
show errors procedure cfsec213.rd_clusbyudescridx;
