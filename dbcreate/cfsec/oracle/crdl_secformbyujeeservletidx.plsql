--
--	@(#) dbcreate/cfsec/oracle/crdl_secformbyujeeservletidx.plsql
--
...
create or replace procedure cfsec213.dl_secformbyujeeservletidx(
...
show errors procedure cfsec213.dl_secformbyujeeservletidx;
