--
--	@(#) dbcreate/cfsec/oracle/crdl_secincbyclusteridx.plsql
--
...
create or replace procedure cfsec213.dl_secincbyclusteridx(
...
show errors procedure cfsec213.dl_secincbyclusteridx;
