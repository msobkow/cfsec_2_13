--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_cntrylngbyididx.plsql
--
...
create or replace procedure cfsec213.rd_iso_cntrylngbyididx(
...
show errors procedure cfsec213.rd_iso_cntrylngbyididx;
