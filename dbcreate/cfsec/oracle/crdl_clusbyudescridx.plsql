--
--	@(#) dbcreate/cfsec/oracle/crdl_clusbyudescridx.plsql
--
...
create or replace procedure cfsec213.dl_clusbyudescridx(
...
show errors procedure cfsec213.dl_clusbyudescridx;
