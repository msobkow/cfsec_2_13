--
--	@(#) dbcreate/cfsec/oracle/crcrt_isotz.plsql
--
...
create or replace procedure cfsec213.crt_isotz(
...
begin
	...
	argISOTZoneId := cfsec213.nxt_isotzoneidgen();
...
show errors procedure cfsec213.crt_isotz;
