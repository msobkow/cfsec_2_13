--
--	@(#) dbcreate/cfsec/oracle/crdl_secgrpfrmbyididx.plsql
--
...
create or replace procedure cfsec213.dl_secgrpfrmbyididx(
...
show errors procedure cfsec213.dl_secgrpfrmbyididx;
