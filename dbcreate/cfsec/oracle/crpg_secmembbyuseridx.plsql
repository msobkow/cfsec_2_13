--
--	@(#) dbcreate/cfsec/oracle/crpg_secmembbyuseridx.plsql
--
...
create or replace procedure cfsec213.pg_secmembbyuseridx(
...
end pg_secmembbyuseridx;
/

show errors procedure cfsec213.pg_secmembbyuseridx;
