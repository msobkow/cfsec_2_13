--
--	@(#) dbcreate/cfsec/oracle/crrd_tsecincbyuincludeidx.plsql
--
...
create or replace procedure cfsec213.rd_tsecincbyuincludeidx(
...
show errors procedure cfsec213.rd_tsecincbyuincludeidx;
