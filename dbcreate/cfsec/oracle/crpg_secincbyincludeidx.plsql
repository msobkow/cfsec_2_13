--
--	@(#) dbcreate/cfsec/oracle/crpg_secincbyincludeidx.plsql
--
...
create or replace procedure cfsec213.pg_secincbyincludeidx(
...
end pg_secincbyincludeidx;
/

show errors procedure cfsec213.pg_secincbyincludeidx;
