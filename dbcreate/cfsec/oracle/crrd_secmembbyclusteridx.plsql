--
--	@(#) dbcreate/cfsec/oracle/crrd_secmembbyclusteridx.plsql
--
...
create or replace procedure cfsec213.rd_secmembbyclusteridx(
...
show errors procedure cfsec213.rd_secmembbyclusteridx;
