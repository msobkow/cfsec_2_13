--
--	@(#) dbcreate/cfsec/oracle/crpg_secappbyclusteridx.plsql
--
...
create or replace procedure cfsec213.pg_secappbyclusteridx(
...
end pg_secappbyclusteridx;
/

show errors procedure cfsec213.pg_secappbyclusteridx;
