--
--	@(#) dbcreate/cfsec/oracle/crdl_secgrpfrmbyuformidx.plsql
--
...
create or replace procedure cfsec213.dl_secgrpfrmbyuformidx(
...
show errors procedure cfsec213.dl_secgrpfrmbyuformidx;
