--
--	@(#) dbcreate/cfsec/oracle/crdl_iso_cntrybyisocodeidx.plsql
--
...
create or replace procedure cfsec213.dl_iso_cntrybyisocodeidx(
...
show errors procedure cfsec213.dl_iso_cntrybyisocodeidx;
