--
--	@(#) dbcreate/cfsec/oracle/crrd_hostsvcbyuhostportidx.plsql
--
...
create or replace procedure cfsec213.rd_hostsvcbyuhostportidx(
...
show errors procedure cfsec213.rd_hostsvcbyuhostportidx;
