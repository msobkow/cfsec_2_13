--
--	@(#) dbcreate/cfsec/oracle/crrd_tenantbyclusteridx.plsql
--
...
create or replace procedure cfsec213.rd_tenantbyclusteridx(
...
show errors procedure cfsec213.rd_tenantbyclusteridx;
