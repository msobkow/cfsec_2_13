--
--	@(#) dbcreate/cfsec/oracle/crdl_secmembbyuseridx.plsql
--
...
create or replace procedure cfsec213.dl_secmembbyuseridx(
...
show errors procedure cfsec213.dl_secmembbyuseridx;
