--
--	@(#) dbcreate/cfsec/oracle/crrd_secgrpfrmbyididx.plsql
--
...
create or replace procedure cfsec213.rd_secgrpfrmbyididx(
...
show errors procedure cfsec213.rd_secgrpfrmbyididx;
