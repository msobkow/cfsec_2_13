--
--	@(#) dbcreate/cfsec/oracle/crrd_tsecgrpbytenantidx.plsql
--
...
create or replace procedure cfsec213.rd_tsecgrpbytenantidx(
...
show errors procedure cfsec213.rd_tsecgrpbytenantidx;
