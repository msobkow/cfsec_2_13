--
--	@(#) dbcreate/cfsec/oracle/crrd_tsecgrpbyunameidx.plsql
--
...
create or replace procedure cfsec213.rd_tsecgrpbyunameidx(
...
show errors procedure cfsec213.rd_tsecgrpbyunameidx;
