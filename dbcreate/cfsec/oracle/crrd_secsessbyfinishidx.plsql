--
--	@(#) dbcreate/cfsec/oracle/crrd_secsessbyfinishidx.plsql
--
...
create or replace procedure cfsec213.rd_secsessbyfinishidx(
	...
	argfinish_ts timestamp ) authid definer
is
begin
...
show errors procedure cfsec213.rd_secsessbyfinishidx;
