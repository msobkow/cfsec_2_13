--
--	@(#) dbcreate/cfsec/oracle/crdl_secgrpbyunameidx.plsql
--
...
create or replace procedure cfsec213.dl_secgrpbyunameidx(
...
show errors procedure cfsec213.dl_secgrpbyunameidx;
