--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_cntryccybyididx.plsql
--
...
create or replace procedure cfsec213.rd_iso_cntryccybyididx(
...
show errors procedure cfsec213.rd_iso_cntryccybyididx;
