--
--	@(#) dbcreate/cfsec/oracle/crrd_secgrpfrmbyformidx.plsql
--
...
create or replace procedure cfsec213.rd_secgrpfrmbyformidx(
...
show errors procedure cfsec213.rd_secgrpfrmbyformidx;
