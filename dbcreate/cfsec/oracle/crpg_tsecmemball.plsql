--
--	@(#) dbcreate/cfsec/oracle/crpg_tsecmemball.plsql
--
...
create or replace procedure cfsec213.pg_tsecmemball(
...
begin
	...
	then
		open retCursor for
			...
			where ( ( ( a018.TenantId = priorTenantId )
...
show errors procedure cfsec213.pg_tsecmemball;
