--
--	@(#) dbcreate/cfsec/oracle/crpg_secgrpfrmbyformidx.plsql
--
...
create or replace procedure cfsec213.pg_secgrpfrmbyformidx(
...
end pg_secgrpfrmbyformidx;
/

show errors procedure cfsec213.pg_secgrpfrmbyformidx;
