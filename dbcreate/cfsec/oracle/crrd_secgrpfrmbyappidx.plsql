--
--	@(#) dbcreate/cfsec/oracle/crrd_secgrpfrmbyappidx.plsql
--
...
create or replace procedure cfsec213.rd_secgrpfrmbyappidx(
...
show errors procedure cfsec213.rd_secgrpfrmbyappidx;
