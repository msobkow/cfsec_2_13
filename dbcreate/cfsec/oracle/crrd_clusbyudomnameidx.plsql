--
--	@(#) dbcreate/cfsec/oracle/crrd_clusbyudomnameidx.plsql
--
...
create or replace procedure cfsec213.rd_clusbyudomnameidx(
...
end rd_clusbyudomnameidx;
/

show errors procedure cfsec213.rd_clusbyudomnameidx;
