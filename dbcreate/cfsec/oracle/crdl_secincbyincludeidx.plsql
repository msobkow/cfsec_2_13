--
--	@(#) dbcreate/cfsec/oracle/crdl_secincbyincludeidx.plsql
--
...
create or replace procedure cfsec213.dl_secincbyincludeidx(
...
show errors procedure cfsec213.dl_secincbyincludeidx;
