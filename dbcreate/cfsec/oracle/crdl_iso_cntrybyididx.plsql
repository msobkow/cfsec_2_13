--
--	@(#) dbcreate/cfsec/oracle/crdl_iso_cntrybyididx.plsql
--
...
create or replace procedure cfsec213.dl_iso_cntrybyididx(
...
show errors procedure cfsec213.dl_iso_cntrybyididx;
