--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_cntryccybyctryidx.plsql
--
...
create or replace procedure cfsec213.rd_iso_cntryccybyctryidx(
...
begin
	...
	where
		...
		order by ISOCtryId desc,
			ISOCcyId desc;
end rd_iso_cntryccybyctryidx;
/

show errors procedure cfsec213.rd_iso_cntryccybyctryidx;
