--
--	@(#) dbcreate/cfsec/oracle/crrd_secmembbyuseridx.plsql
--
...
create or replace procedure cfsec213.rd_secmembbyuseridx(
...
show errors procedure cfsec213.rd_secmembbyuseridx;
