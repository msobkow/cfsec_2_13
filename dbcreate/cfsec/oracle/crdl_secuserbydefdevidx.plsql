--
--	@(#) dbcreate/cfsec/oracle/crdl_secuserbydefdevidx.plsql
--
...
create or replace procedure cfsec213.dl_secuserbydefdevidx(
...
show errors procedure cfsec213.dl_secuserbydefdevidx;
