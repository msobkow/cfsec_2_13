--
--	@(#) dbcreate/cfsec/oracle/crrd_secsessbystartidx.plsql
--
...
create or replace procedure cfsec213.rd_secsessbystartidx(
...
show errors procedure cfsec213.rd_secsessbystartidx;
