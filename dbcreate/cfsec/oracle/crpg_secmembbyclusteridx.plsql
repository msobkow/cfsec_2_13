--
--	@(#) dbcreate/cfsec/oracle/crpg_secmembbyclusteridx.plsql
--
...
create or replace procedure cfsec213.pg_secmembbyclusteridx(
...
end pg_secmembbyclusteridx;
/

show errors procedure cfsec213.pg_secmembbyclusteridx;
