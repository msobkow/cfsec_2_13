--
--	@(#) dbcreate/cfsec/oracle/crrd_tsecmembbyuuseridx.plsql
--
...
create or replace procedure cfsec213.rd_tsecmembbyuuseridx(
...
show errors procedure cfsec213.rd_tsecmembbyuuseridx;
