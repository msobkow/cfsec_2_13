--
--	@(#) dbcreate/cfsec/oracle/crrd_tsecmembbytenantidx.plsql
--
...
create or replace procedure cfsec213.rd_tsecmembbytenantidx(
...
show errors procedure cfsec213.rd_tsecmembbytenantidx;
