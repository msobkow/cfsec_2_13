--
--	@(#) dbcreate/cfsec/oracle/crrd_hostsvcbyclusteridx.plsql
--
...
create or replace procedure cfsec213.rd_hostsvcbyclusteridx(
...
show errors procedure cfsec213.rd_hostsvcbyclusteridx;
