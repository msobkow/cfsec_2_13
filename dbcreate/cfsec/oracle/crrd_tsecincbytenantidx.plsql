--
--	@(#) dbcreate/cfsec/oracle/crrd_tsecincbytenantidx.plsql
--
...
create or replace procedure cfsec213.rd_tsecincbytenantidx(
...
show errors procedure cfsec213.rd_tsecincbytenantidx;
