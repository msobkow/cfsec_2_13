--
--	@(#) dbcreate/cfsec/oracle/crrd_secgrpbyclusteridx.plsql
--
...
create or replace procedure cfsec213.rd_secgrpbyclusteridx(
...
show errors procedure cfsec213.rd_secgrpbyclusteridx;
