--
--	@(#) dbcreate/cfsec/oracle/crdl_isotzbyiso8601idx.plsql
--
...
create or replace procedure cfsec213.dl_isotzbyiso8601idx(
...
show errors procedure cfsec213.dl_isotzbyiso8601idx;
