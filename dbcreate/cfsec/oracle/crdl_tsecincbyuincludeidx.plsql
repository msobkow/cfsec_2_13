--
--	@(#) dbcreate/cfsec/oracle/crdl_tsecincbyuincludeidx.plsql
--
...
create or replace procedure cfsec213.dl_tsecincbyuincludeidx(
...
show errors procedure cfsec213.dl_tsecincbyuincludeidx;
