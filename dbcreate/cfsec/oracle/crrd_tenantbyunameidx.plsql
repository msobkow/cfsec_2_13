--
--	@(#) dbcreate/cfsec/oracle/crrd_tenantbyunameidx.plsql
--
...
create or replace procedure cfsec213.rd_tenantbyunameidx(
...
show errors procedure cfsec213.rd_tenantbyunameidx;
