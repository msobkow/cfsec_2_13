--
--	@(#) dbcreate/cfsec/oracle/crrd_tsecmembbygroupidx.plsql
--
...
create or replace procedure cfsec213.rd_tsecmembbygroupidx(
...
show errors procedure cfsec213.rd_tsecmembbygroupidx;
