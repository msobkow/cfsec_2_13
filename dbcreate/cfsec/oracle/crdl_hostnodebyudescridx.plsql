--
--	@(#) dbcreate/cfsec/oracle/crdl_hostnodebyudescridx.plsql
--
...
create or replace procedure cfsec213.dl_hostnodebyudescridx(
...
show errors procedure cfsec213.dl_hostnodebyudescridx;
