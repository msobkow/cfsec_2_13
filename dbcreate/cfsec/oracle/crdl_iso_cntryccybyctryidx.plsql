--
--	@(#) dbcreate/cfsec/oracle/crdl_iso_cntryccybyctryidx.plsql
--
...
create or replace procedure cfsec213.dl_iso_cntryccybyctryidx(
...
end dl_iso_cntryccybyctryidx;
/

show errors procedure cfsec213.dl_iso_cntryccybyctryidx;
