--
--	@(#) dbcreate/cfsec/oracle/crdl_iso_cntrylngbyididx.plsql
--
...
create or replace procedure cfsec213.dl_iso_cntrylngbyididx(
...
show errors procedure cfsec213.dl_iso_cntrylngbyididx;
