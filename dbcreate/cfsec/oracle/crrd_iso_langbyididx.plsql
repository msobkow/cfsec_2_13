--
--	@(#) dbcreate/cfsec/oracle/crrd_iso_langbyididx.plsql
--
...
create or replace procedure cfsec213.rd_iso_langbyididx(
...
show errors procedure cfsec213.rd_iso_langbyididx;
