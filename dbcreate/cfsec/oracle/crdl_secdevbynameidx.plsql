--
--	@(#) dbcreate/cfsec/oracle/crdl_secdevbynameidx.plsql
--
...
create or replace procedure cfsec213.dl_secdevbynameidx(
...
begin
	...
	loop
			cfsec213.dl_secdev( argAuditClusterId,
					argAuditUserId,
					argAuditSessionId,
					secClusterId,
					secTenantId,
...
end dl_secdevbynameidx;
/

show errors procedure cfsec213.dl_secdevbynameidx;
