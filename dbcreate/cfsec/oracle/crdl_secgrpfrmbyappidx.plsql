--
--	@(#) dbcreate/cfsec/oracle/crdl_secgrpfrmbyappidx.plsql
--
...
create or replace procedure cfsec213.dl_secgrpfrmbyappidx(
...
show errors procedure cfsec213.dl_secgrpfrmbyappidx;
