--
--	@(#) dbcreate/cfsec/oracle/crpg_secformbyclusteridx.plsql
--
...
create or replace procedure cfsec213.pg_secformbyclusteridx(
...
end pg_secformbyclusteridx;
/

show errors procedure cfsec213.pg_secformbyclusteridx;
