--
--	@(#) dbcreate/cfsec/oracle/crpg_secsessbysecproxyidx.plsql
--
...
create or replace procedure cfsec213.pg_secsessbysecproxyidx(
...
end pg_secsessbysecproxyidx;
/

show errors procedure cfsec213.pg_secsessbysecproxyidx;
