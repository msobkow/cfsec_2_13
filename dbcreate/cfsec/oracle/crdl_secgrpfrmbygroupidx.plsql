--
--	@(#) dbcreate/cfsec/oracle/crdl_secgrpfrmbygroupidx.plsql
--
...
create or replace procedure cfsec213.dl_secgrpfrmbygroupidx(
...
show errors procedure cfsec213.dl_secgrpfrmbygroupidx;
