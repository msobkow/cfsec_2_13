--
--	@(#) dbcreate/cfsec/oracle/crrd_secincbyincludeidx.plsql
--
...
create or replace procedure cfsec213.rd_secincbyincludeidx(
...
show errors procedure cfsec213.rd_secincbyincludeidx;
