--
--	@(#) dbcreate/cfsec/oracle/crpg_hostnodebyclusteridx.plsql
--
...
create or replace procedure cfsec213.pg_hostnodebyclusteridx(
...
show errors procedure cfsec213.pg_hostnodebyclusteridx;
