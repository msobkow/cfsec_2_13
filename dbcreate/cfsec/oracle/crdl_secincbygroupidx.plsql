--
--	@(#) dbcreate/cfsec/oracle/crdl_secincbygroupidx.plsql
--
...
create or replace procedure cfsec213.dl_secincbygroupidx(
...
show errors procedure cfsec213.dl_secincbygroupidx;
