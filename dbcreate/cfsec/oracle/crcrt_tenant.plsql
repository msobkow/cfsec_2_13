--
--	@(#) dbcreate/cfsec/oracle/crcrt_tenant.plsql
--
...
create or replace procedure cfsec213.crt_tenant(
...
begin
	...
	argId := cfsec213.nxt_tenantidgen();
...
show errors procedure cfsec213.crt_tenant;
