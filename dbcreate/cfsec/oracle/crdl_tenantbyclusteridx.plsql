--
--	@(#) dbcreate/cfsec/oracle/crdl_tenantbyclusteridx.plsql
--
...
create or replace procedure cfsec213.dl_tenantbyclusteridx(
...
show errors procedure cfsec213.dl_tenantbyclusteridx;
