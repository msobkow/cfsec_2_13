--
--	@(#) dbcreate/cfsec/oracle/crdl_secgrpbyclustervisidx.plsql
--
...
create or replace procedure cfsec213.dl_secgrpbyclustervisidx(
...
end dl_secgrpbyclustervisidx;
/

show errors procedure cfsec213.dl_secgrpbyclustervisidx;
