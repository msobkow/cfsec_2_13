--
--	@(#) dbcreate/cfsec/oracle/crdl_secsessbyfinishidx.plsql
--
...
create or replace procedure cfsec213.dl_secsessbyfinishidx(
...
show errors procedure cfsec213.dl_secsessbyfinishidx;
