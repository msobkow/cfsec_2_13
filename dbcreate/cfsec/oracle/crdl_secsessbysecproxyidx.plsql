--
--	@(#) dbcreate/cfsec/oracle/crdl_secsessbysecproxyidx.plsql
--
...
create or replace procedure cfsec213.dl_secsessbysecproxyidx(
...
show errors procedure cfsec213.dl_secsessbysecproxyidx;
