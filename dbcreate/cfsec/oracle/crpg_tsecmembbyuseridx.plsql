--
--	@(#) dbcreate/cfsec/oracle/crpg_tsecmembbyuseridx.plsql
--
...
create or replace procedure cfsec213.pg_tsecmembbyuseridx(
...
end pg_tsecmembbyuseridx;
/

show errors procedure cfsec213.pg_tsecmembbyuseridx;
