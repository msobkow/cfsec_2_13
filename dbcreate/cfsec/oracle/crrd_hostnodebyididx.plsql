--
--	@(#) dbcreate/cfsec/oracle/crrd_hostnodebyididx.plsql
--
...
create or replace procedure cfsec213.rd_hostnodebyididx(
...
show errors procedure cfsec213.rd_hostnodebyididx;
