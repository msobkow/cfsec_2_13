--
--	@(#) dbcreate/cfsec/oracle/crrd_secgrpbyunameidx.plsql
--
...
create or replace procedure cfsec213.rd_secgrpbyunameidx(
...
show errors procedure cfsec213.rd_secgrpbyunameidx;
