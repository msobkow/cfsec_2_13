--
--	@(#) dbcreate/cfsec/oracle/crrd_secgrpfrmbyuformidx.plsql
--
...
create or replace procedure cfsec213.rd_secgrpfrmbyuformidx(
...
show errors procedure cfsec213.rd_secgrpfrmbyuformidx;
