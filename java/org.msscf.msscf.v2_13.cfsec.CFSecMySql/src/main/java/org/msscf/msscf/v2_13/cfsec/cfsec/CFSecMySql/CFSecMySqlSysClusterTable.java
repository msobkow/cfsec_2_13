// Description: Java 11 MySQL Jdbc DbIO implementation for SysCluster.
...
/*
 *	CFSecMySqlSysClusterTable MySQL Jdbc DbIO implementation
 *	for SysCluster.
 */
public class CFSecMySqlSysClusterTable
	implements ICFSecSysClusterTable
{
	...
	public CFSecMySqlSysClusterTable( CFSecMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSysClusterBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int SingletonId )
	{
		final String S_ProcName = "CFSecMySqlSysClusterTable.readDerivedByIdIdx() ";
		CFSecSysClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
