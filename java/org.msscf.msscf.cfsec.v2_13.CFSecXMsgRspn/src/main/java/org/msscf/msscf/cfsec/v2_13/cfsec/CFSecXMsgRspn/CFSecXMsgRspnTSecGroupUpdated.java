...
/*
 *	CFSecXMsgRspnTSecGroupUpdated XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFSecXMsgRspnTSecGroupUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnTSecGroupUpdated( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
