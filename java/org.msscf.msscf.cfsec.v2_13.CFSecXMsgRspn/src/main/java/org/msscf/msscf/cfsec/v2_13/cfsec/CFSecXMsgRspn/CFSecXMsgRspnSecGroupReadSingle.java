...
/*
 *	CFSecXMsgRspnSecGroupReadSingle XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFSecXMsgRspnSecGroupReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSecGroupReadSingle( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
