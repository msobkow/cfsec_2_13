...
/*
 *	CFSecXMsgRspnTSecGroupReadSingle XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFSecXMsgRspnTSecGroupReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnTSecGroupReadSingle( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
