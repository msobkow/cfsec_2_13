...
/*
 *	CFSecXMsgRspnSysClusterReadSingle XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFSecXMsgRspnSysClusterReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSysClusterReadSingle( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
