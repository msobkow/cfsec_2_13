...
/*
 *	CFSecXMsgRspnSecGroupCreated XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFSecXMsgRspnSecGroupCreated
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSecGroupCreated( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
