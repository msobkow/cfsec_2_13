...
/*
 *	CFSecXMsgRspnHostNodeLocked XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRspnHostNodeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnHostNodeLocked( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
