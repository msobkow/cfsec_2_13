...
/*
 *	CFSecXMsgRspnHostNodeDeleted XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRspnHostNodeDeleted
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnHostNodeDeleted( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
