...
package org.msscf.msscf.v2_13.cfsec.cfsec.CFSecSaxDb2LUWLdr;
...
import org.msscf.msscf.v2_13.cfsec.cfsec.CFSecDb2LUW.*;
import org.msscf.msscf.v2_13.cfsec.cfsec.CFSecSaxLoader.*;

public class CFSecSaxDb2LUWLdr
	extends CFSecSaxLdr
{
	...
	public static void main( String args[] ) {
		final String S_ProcName = "CFSecSaxDb2LUWLdr.main() ";
		initConsoleLog();
		...
		if( numArgs >= 2 ) {
			...
			String cFSecConfigFileName = homeDir.getPath() + File.separator + ".cfsecdb2luwrc";
			...
			Logger httpLogger = Logger.getLogger( CFSecSaxDb2LUWLdr.class );
			httpLogger.setLevel( Level.WARN );

			ICFSecSchema cFSecSchema = new CFSecDb2LUWSchema();
			...
			CFSecSaxLdr cli = new CFSecSaxDb2LUWLdr();
...
//		BasicConfigurator.configure( new ConsoleAppender( layout, "System.out" ) );
	...
	public void evaluateRemainingArgs( String[] args, int consumed ) {
		...
		if( args.length > consumed ) {
			log.message( "CFSecSaxDb2LUWLdr.evaluateRemainingArgs() WARNING No extra arguments are expected for a RAM database instance, but "
