...
/*
 *	CFSecXMsgRspnServiceTypeCreated XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFSecXMsgRspnServiceTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnServiceTypeCreated( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
