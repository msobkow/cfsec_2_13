...
/*
 *	CFSecXMsgRspnTenantUpdated XML SAX Element  implementation
 *	for Tenant.
 */
public class CFSecXMsgRspnTenantUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnTenantUpdated( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
