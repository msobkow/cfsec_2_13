...
/*
 *	CFSecXMsgRspnSecGroupFormCreated XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFSecXMsgRspnSecGroupFormCreated
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSecGroupFormCreated( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
