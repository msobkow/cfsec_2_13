...
/*
 *	CFSecXMsgRspnSysClusterRec XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFSecXMsgRspnSysClusterRec
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSysClusterRec( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
