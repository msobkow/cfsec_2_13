...
/*
 *	CFSecXMsgRspnSecGroupReadList XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFSecXMsgRspnSecGroupReadList
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSecGroupReadList( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
