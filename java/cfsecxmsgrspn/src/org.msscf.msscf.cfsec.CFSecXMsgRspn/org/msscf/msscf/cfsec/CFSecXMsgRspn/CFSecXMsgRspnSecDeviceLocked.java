...
/*
 *	CFSecXMsgRspnSecDeviceLocked XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRspnSecDeviceLocked
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSecDeviceLocked( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
