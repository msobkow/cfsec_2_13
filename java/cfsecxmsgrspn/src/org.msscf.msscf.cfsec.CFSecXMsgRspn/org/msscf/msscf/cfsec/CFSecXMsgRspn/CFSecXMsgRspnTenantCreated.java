...
/*
 *	CFSecXMsgRspnTenantCreated XML SAX Element  implementation
 *	for Tenant.
 */
public class CFSecXMsgRspnTenantCreated
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnTenantCreated( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
