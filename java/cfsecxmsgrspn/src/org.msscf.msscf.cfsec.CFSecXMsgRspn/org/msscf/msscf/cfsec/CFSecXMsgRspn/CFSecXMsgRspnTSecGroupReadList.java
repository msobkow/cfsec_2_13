...
/*
 *	CFSecXMsgRspnTSecGroupReadList XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFSecXMsgRspnTSecGroupReadList
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnTSecGroupReadList( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
