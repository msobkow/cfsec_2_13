...
/*
 *	CFSecXMsgRspnServerProcExecuted XML SAX Element  implementation
 */
public class CFSecXMsgRspnServerProcExecuted
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnServerProcExecuted( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
