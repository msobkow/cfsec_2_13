...
/*
 *	CFSecXMsgRspnSecGroupFormRec XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFSecXMsgRspnSecGroupFormRec
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSecGroupFormRec( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
