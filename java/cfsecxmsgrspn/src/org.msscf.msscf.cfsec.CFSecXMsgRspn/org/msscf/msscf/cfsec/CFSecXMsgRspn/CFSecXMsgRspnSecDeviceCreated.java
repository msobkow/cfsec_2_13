...
/*
 *	CFSecXMsgRspnSecDeviceCreated XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRspnSecDeviceCreated
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSecDeviceCreated( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
