...
/*
 *	CFSecXMsgRspnTSecGroupLocked XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFSecXMsgRspnTSecGroupLocked
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnTSecGroupLocked( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
