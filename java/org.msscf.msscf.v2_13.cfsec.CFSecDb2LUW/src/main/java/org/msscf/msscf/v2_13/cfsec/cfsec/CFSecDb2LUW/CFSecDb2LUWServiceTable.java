...
/*
 *	CFSecDb2LUWServiceTable DB/2 LUW Jdbc DbIO implementation
 *	for Service.
 */
public class CFSecDb2LUWServiceTable
	implements ICFSecServiceTable
{
	...
	public CFSecDb2LUWServiceTable( CFSecDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecServiceBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long ServiceId )
	{
		final String S_ProcName = "CFSecDb2LUWServiceTable.readDerivedByIdIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceBuff readDerivedByUTypeIdx( CFSecAuthorization Authorization,
		...
		int ServiceTypeId )
	{
		final String S_ProcName = "CFSecDb2LUWServiceTable.readDerivedByUTypeIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceBuff readDerivedByUHostPortIdx( CFSecAuthorization Authorization,
		...
		short HostPort )
	{
		final String S_ProcName = "CFSecDb2LUWServiceTable.readDerivedByUHostPortIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
