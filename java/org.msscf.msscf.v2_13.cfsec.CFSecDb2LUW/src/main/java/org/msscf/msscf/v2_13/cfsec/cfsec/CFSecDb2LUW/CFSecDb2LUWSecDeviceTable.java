...
/*
 *	CFSecDb2LUWSecDeviceTable DB/2 LUW Jdbc DbIO implementation
 *	for SecDevice.
 */
public class CFSecDb2LUWSecDeviceTable
	implements ICFSecSecDeviceTable
{
	...
	public CFSecDb2LUWSecDeviceTable( CFSecDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecDeviceBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		String DevName )
	{
		final String S_ProcName = "CFSecDb2LUWSecDeviceTable.readDerivedByIdIdx() ";
		CFSecSecDeviceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecDeviceBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String DevName )
	{
		final String S_ProcName = "CFSecDb2LUWSecDeviceTable.readDerivedByNameIdx() ";
		CFSecSecDeviceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
