...
/*
 *	CFSecDb2LUWISOCtryCcyTable DB/2 LUW Jdbc DbIO implementation
 *	for ISOCtryCcy.
 */
public class CFSecDb2LUWISOCtryCcyTable
	implements ICFSecISOCtryCcyTable
{
	...
	public CFSecDb2LUWISOCtryCcyTable( CFSecDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOCcyId )
	{
		final String S_ProcName = "CFSecDb2LUWISOCtryCcyTable.readDerivedByIdIdx() ";
		CFSecISOCtryCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
