...
/*
 *	CFSecDb2LUWSecGroupFormTable DB/2 LUW Jdbc DbIO implementation
 *	for SecGroupForm.
 */
public class CFSecDb2LUWSecGroupFormTable
	implements ICFSecSecGroupFormTable
{
	...
	public CFSecDb2LUWSecGroupFormTable( CFSecDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGroupFormBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGroupFormId )
	{
		final String S_ProcName = "CFSecDb2LUWSecGroupFormTable.readDerivedByIdIdx() ";
		CFSecSecGroupFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGroupFormBuff readDerivedByUFormIdx( CFSecAuthorization Authorization,
		...
		int SecFormId )
	{
		final String S_ProcName = "CFSecDb2LUWSecGroupFormTable.readDerivedByUFormIdx() ";
		CFSecSecGroupFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
