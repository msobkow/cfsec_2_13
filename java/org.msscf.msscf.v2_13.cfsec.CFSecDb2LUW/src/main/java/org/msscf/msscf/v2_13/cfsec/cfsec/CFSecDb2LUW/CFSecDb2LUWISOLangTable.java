...
/*
 *	CFSecDb2LUWISOLangTable DB/2 LUW Jdbc DbIO implementation
 *	for ISOLang.
 */
public class CFSecDb2LUWISOLangTable
	implements ICFSecISOLangTable
{
	...
	public CFSecDb2LUWISOLangTable( CFSecDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOLangId )
	{
		final String S_ProcName = "CFSecDb2LUWISOLangTable.readDerivedByIdIdx() ";
		CFSecISOLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOLangBuff readDerivedByCode3Idx( CFSecAuthorization Authorization,
		String ISO6392Code )
	{
		final String S_ProcName = "CFSecDb2LUWISOLangTable.readDerivedByCode3Idx() ";
		CFSecISOLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
