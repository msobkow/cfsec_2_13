...
/*
 *	CFSecDb2LUWSecGrpMembTable DB/2 LUW Jdbc DbIO implementation
 *	for SecGrpMemb.
 */
public class CFSecDb2LUWSecGrpMembTable
	implements ICFSecSecGrpMembTable
{
	...
	public CFSecDb2LUWSecGrpMembTable( CFSecDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpMembId )
	{
		final String S_ProcName = "CFSecDb2LUWSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFSecDb2LUWSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
