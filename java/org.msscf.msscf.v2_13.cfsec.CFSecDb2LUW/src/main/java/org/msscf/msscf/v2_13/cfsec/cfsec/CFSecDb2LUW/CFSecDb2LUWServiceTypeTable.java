...
/*
 *	CFSecDb2LUWServiceTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for ServiceType.
 */
public class CFSecDb2LUWServiceTypeTable
	implements ICFSecServiceTypeTable
{
	...
	public CFSecDb2LUWServiceTypeTable( CFSecDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecServiceTypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int ServiceTypeId )
	{
		final String S_ProcName = "CFSecDb2LUWServiceTypeTable.readDerivedByIdIdx() ";
		CFSecServiceTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceTypeBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		String Description )
	{
		final String S_ProcName = "CFSecDb2LUWServiceTypeTable.readDerivedByUDescrIdx() ";
		CFSecServiceTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
