...
/*
 *	CFSecDb2LUWSysClusterTable DB/2 LUW Jdbc DbIO implementation
 *	for SysCluster.
 */
public class CFSecDb2LUWSysClusterTable
	implements ICFSecSysClusterTable
{
	...
	public CFSecDb2LUWSysClusterTable( CFSecDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSysClusterBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int SingletonId )
	{
		final String S_ProcName = "CFSecDb2LUWSysClusterTable.readDerivedByIdIdx() ";
		CFSecSysClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
