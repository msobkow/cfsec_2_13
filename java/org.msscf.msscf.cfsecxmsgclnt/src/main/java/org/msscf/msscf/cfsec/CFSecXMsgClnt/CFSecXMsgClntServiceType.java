...
/*
 *	CFSecXMsgClntServiceType XMsg Client DbIO implementation
 *	for ServiceType.
 */
public class CFSecXMsgClntServiceType
	implements ICFSecServiceTypeTable
{
	private CFSecXMsgClntSchema schema;

	public CFSecXMsgClntServiceType( CFSecXMsgClntSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecServiceTypeBuff Buff )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRqstCreate( "\n\t\t\t", Buff )
			+	"\n"
		...
		if( lastObjectProcessed != null ) {
			ICFSecServiceTypeObj realised = null;
			if( lastObjectProcessed instanceof ICFSecServiceTypeObj ) {
				realised = (ICFSecServiceTypeObj)lastObjectProcessed;
			}
			else {
		...
		CFSecServiceTypePKey PKey )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRqstRead( "\n\t\t\t", PKey )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFSecServiceTypePKey PKey )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRqstLock( "\n\t\t\t", PKey )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
	...
	public CFSecServiceTypeBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRqstReadAll( "\n\t\t\t" )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		int argServiceTypeId )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRqstRdByIdIdx( "\n\t\t\t",
							argServiceTypeId )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		String argDescription )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRqstRdByUDescrIdx( "\n\t\t\t",
							argDescription )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		CFSecServiceTypeBuff Buff )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRqstUpdate( "\n\t\t\t", Buff )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFSecServiceTypeBuff Buff )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRqstDelete( "\n\t\t\t", Buff )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		int argServiceTypeId )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRqstDelByIdIdx( "\n\t\t\t",
							argServiceTypeId )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		String argDescription )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRqstDelByUDescrIdx( "\n\t\t\t",
							argDescription )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
