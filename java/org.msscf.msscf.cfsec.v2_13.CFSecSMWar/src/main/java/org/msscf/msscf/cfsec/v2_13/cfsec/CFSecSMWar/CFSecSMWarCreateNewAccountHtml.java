 ...
 */
@WebServlet("/CFSecSMWarCreateNewAccountHtml")
public class CFSecSMWarCreateNewAccountHtml extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CFSecSMWarCreateNewAccountHtml() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.println( "<HTML>" );
			out.println( "<BODY>" );
			out.println( "<form method=\"post\" formaction=\"CFSecSMWarCreateNewAccountHtml\">" );
