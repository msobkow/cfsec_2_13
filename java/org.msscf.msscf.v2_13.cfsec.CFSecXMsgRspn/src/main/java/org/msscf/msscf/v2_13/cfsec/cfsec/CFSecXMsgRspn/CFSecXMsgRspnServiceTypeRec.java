...
/*
 *	CFSecXMsgRspnServiceTypeRec XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFSecXMsgRspnServiceTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnServiceTypeRec( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
