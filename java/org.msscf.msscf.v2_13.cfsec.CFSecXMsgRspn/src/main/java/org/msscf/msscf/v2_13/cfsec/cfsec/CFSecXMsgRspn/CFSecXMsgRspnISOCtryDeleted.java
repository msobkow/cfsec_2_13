...
/*
 *	CFSecXMsgRspnISOCtryDeleted XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFSecXMsgRspnISOCtryDeleted
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnISOCtryDeleted( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
