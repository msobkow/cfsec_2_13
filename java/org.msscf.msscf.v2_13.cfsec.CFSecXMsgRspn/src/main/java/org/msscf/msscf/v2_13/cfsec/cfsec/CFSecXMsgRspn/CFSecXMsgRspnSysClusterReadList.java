...
/*
 *	CFSecXMsgRspnSysClusterReadList XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFSecXMsgRspnSysClusterReadList
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSysClusterReadList( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
