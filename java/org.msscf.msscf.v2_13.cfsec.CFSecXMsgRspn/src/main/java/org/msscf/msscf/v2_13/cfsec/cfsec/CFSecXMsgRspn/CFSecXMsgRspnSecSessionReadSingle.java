...
/*
 *	CFSecXMsgRspnSecSessionReadSingle XML SAX Element  implementation
 *	for SecSession.
 */
public class CFSecXMsgRspnSecSessionReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSecSessionReadSingle( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
