...
/*
 *	CFSecXMsgRspnISOCtryLangLocked XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFSecXMsgRspnISOCtryLangLocked
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnISOCtryLangLocked( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
