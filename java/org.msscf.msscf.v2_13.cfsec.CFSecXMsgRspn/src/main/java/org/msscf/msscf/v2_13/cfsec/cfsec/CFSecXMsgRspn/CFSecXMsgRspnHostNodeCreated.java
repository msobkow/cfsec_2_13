...
/*
 *	CFSecXMsgRspnHostNodeCreated XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRspnHostNodeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnHostNodeCreated( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
