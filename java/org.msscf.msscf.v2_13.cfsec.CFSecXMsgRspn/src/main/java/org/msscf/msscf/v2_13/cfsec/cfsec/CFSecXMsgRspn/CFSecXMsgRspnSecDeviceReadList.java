...
/*
 *	CFSecXMsgRspnSecDeviceReadList XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRspnSecDeviceReadList
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRspnSecDeviceReadList( CFSecXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
