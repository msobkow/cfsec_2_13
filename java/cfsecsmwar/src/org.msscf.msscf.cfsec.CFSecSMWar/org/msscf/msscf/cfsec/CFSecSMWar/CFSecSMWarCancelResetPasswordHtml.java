...
/**
 * Servlet implementation class CFSecSMWarCancelResetPasswordHtml
 */
@WebServlet("/CFSecSMWarCancelResetPasswordHtml")
public class CFSecSMWarCancelResetPasswordHtml extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CFSecSMWarCancelResetPasswordHtml() {
		super();
	}
