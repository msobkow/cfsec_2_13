...
/**
 * Servlet implementation class CFSecSMWarCreateNewAccountHtml
 */
@WebServlet("/CFSecSMWarConfirmEMailAddressHtml")
public class CFSecSMWarConfirmEMailAddressHtml extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CFSecSMWarConfirmEMailAddressHtml() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ICFSecSecUserObj confirmUser = null;
			...
			ICFSecSecUserEditObj editConfirmUser = confirmUser.beginEdit();
