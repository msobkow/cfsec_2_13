...
/*
 *	CFSecPgSqlSecFormTable PostgreSQL Jdbc DbIO implementation
 *	for SecForm.
 */
public class CFSecPgSqlSecFormTable
	implements ICFSecSecFormTable
{
	...
	public CFSecPgSqlSecFormTable( CFSecPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecFormBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecFormId )
	{
		final String S_ProcName = "CFSecPgSqlSecFormTable.readDerivedByIdIdx() ";
		CFSecSecFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	{
		final String S_ProcName = "CFSecPgSqlSecFormTable.readDerivedByUJEEServletIdx() ";
		CFSecSecFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
