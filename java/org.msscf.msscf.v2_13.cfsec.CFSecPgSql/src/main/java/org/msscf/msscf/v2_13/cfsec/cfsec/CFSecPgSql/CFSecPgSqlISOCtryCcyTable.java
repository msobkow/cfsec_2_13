...
/*
 *	CFSecPgSqlISOCtryCcyTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCtryCcy.
 */
public class CFSecPgSqlISOCtryCcyTable
	implements ICFSecISOCtryCcyTable
{
	...
	public CFSecPgSqlISOCtryCcyTable( CFSecPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOCcyId )
	{
		final String S_ProcName = "CFSecPgSqlISOCtryCcyTable.readDerivedByIdIdx() ";
		CFSecISOCtryCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
