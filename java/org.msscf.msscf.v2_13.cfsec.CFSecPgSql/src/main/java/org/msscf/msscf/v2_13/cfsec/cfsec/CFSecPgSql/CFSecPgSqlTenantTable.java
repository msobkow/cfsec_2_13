...
/*
 *	CFSecPgSqlTenantTable PostgreSQL Jdbc DbIO implementation
 *	for Tenant.
 */
public class CFSecPgSqlTenantTable
	implements ICFSecTenantTable
{
	...
	public CFSecPgSqlTenantTable( CFSecPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTenantBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long Id )
	{
		final String S_ProcName = "CFSecPgSqlTenantTable.readDerivedByIdIdx() ";
		CFSecTenantBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTenantBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String TenantName )
	{
		final String S_ProcName = "CFSecPgSqlTenantTable.readDerivedByUNameIdx() ";
		CFSecTenantBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
