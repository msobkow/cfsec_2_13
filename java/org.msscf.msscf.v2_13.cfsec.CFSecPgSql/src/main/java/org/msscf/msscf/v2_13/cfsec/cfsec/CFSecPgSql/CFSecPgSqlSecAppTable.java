...
/*
 *	CFSecPgSqlSecAppTable PostgreSQL Jdbc DbIO implementation
 *	for SecApp.
 */
public class CFSecPgSqlSecAppTable
	implements ICFSecSecAppTable
{
	...
	public CFSecPgSqlSecAppTable( CFSecPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecAppBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecAppId )
	{
		final String S_ProcName = "CFSecPgSqlSecAppTable.readDerivedByIdIdx() ";
		CFSecSecAppBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecAppBuff readDerivedByUJEEMountIdx( CFSecAuthorization Authorization,
		...
		String JEEMountName )
	{
		final String S_ProcName = "CFSecPgSqlSecAppTable.readDerivedByUJEEMountIdx() ";
		CFSecSecAppBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
