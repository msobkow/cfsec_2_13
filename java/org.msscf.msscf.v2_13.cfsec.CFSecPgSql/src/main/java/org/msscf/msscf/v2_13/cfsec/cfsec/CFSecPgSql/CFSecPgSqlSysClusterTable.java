...
/*
 *	CFSecPgSqlSysClusterTable PostgreSQL Jdbc DbIO implementation
 *	for SysCluster.
 */
public class CFSecPgSqlSysClusterTable
	implements ICFSecSysClusterTable
{
	...
	public CFSecPgSqlSysClusterTable( CFSecPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSysClusterBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int SingletonId )
	{
		final String S_ProcName = "CFSecPgSqlSysClusterTable.readDerivedByIdIdx() ";
		CFSecSysClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
