...
/*
 *	CFSecPgSqlISOCcyTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCcy.
 */
public class CFSecPgSqlISOCcyTable
	implements ICFSecISOCcyTable
{
	...
	public CFSecPgSqlISOCcyTable( CFSecPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOCcyId )
	{
		final String S_ProcName = "CFSecPgSqlISOCcyTable.readDerivedByIdIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCcyBuff readDerivedByCcyCdIdx( CFSecAuthorization Authorization,
		String ISOCode )
	{
		final String S_ProcName = "CFSecPgSqlISOCcyTable.readDerivedByCcyCdIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCcyBuff readDerivedByCcyNmIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFSecPgSqlISOCcyTable.readDerivedByCcyNmIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
