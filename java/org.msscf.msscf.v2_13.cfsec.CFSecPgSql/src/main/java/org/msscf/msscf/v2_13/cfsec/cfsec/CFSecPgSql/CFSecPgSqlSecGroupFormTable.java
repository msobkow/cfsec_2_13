...
/*
 *	CFSecPgSqlSecGroupFormTable PostgreSQL Jdbc DbIO implementation
 *	for SecGroupForm.
 */
public class CFSecPgSqlSecGroupFormTable
	implements ICFSecSecGroupFormTable
{
	...
	public CFSecPgSqlSecGroupFormTable( CFSecPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGroupFormBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGroupFormId )
	{
		final String S_ProcName = "CFSecPgSqlSecGroupFormTable.readDerivedByIdIdx() ";
		CFSecSecGroupFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGroupFormBuff readDerivedByUFormIdx( CFSecAuthorization Authorization,
		...
		int SecFormId )
	{
		final String S_ProcName = "CFSecPgSqlSecGroupFormTable.readDerivedByUFormIdx() ";
		CFSecSecGroupFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
