...
/*
 *	CFSecPgSqlISOCtryLangTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCtryLang.
 */
public class CFSecPgSqlISOCtryLangTable
	implements ICFSecISOCtryLangTable
{
	...
	public CFSecPgSqlISOCtryLangTable( CFSecPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOLangId )
	{
		final String S_ProcName = "CFSecPgSqlISOCtryLangTable.readDerivedByIdIdx() ";
		CFSecISOCtryLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
