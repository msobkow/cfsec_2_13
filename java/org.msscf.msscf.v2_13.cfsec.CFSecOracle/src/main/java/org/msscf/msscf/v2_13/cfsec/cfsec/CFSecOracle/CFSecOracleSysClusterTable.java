...
/*
 *	CFSecOracleSysClusterTable Oracle Jdbc DbIO implementation
 *	for SysCluster.
 */
public class CFSecOracleSysClusterTable
	implements ICFSecSysClusterTable
{
	...
	public CFSecOracleSysClusterTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSysClusterBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int SingletonId )
	{
		final String S_ProcName = "CFSecOracleSysClusterTable.readDerivedByIdIdx() ";
		CFSecSysClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
