...
/*
 *	CFSecOracleISOCtryTable Oracle Jdbc DbIO implementation
 *	for ISOCtry.
 */
public class CFSecOracleISOCtryTable
	implements ICFSecISOCtryTable
{
	...
	public CFSecOracleISOCtryTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOCtryId )
	{
		final String S_ProcName = "CFSecOracleISOCtryTable.readDerivedByIdIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCtryBuff readDerivedByISOCodeIdx( CFSecAuthorization Authorization,
		String ISOCode )
	{
		final String S_ProcName = "CFSecOracleISOCtryTable.readDerivedByISOCodeIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCtryBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFSecOracleISOCtryTable.readDerivedByNameIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
