...
/*
 *	CFSecOracleISOCtryLangTable Oracle Jdbc DbIO implementation
 *	for ISOCtryLang.
 */
public class CFSecOracleISOCtryLangTable
	implements ICFSecISOCtryLangTable
{
	...
	public CFSecOracleISOCtryLangTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOLangId )
	{
		final String S_ProcName = "CFSecOracleISOCtryLangTable.readDerivedByIdIdx() ";
		CFSecISOCtryLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
