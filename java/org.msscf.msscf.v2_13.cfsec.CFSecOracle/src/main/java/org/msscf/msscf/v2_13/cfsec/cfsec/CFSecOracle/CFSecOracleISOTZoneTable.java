...
/*
 *	CFSecOracleISOTZoneTable Oracle Jdbc DbIO implementation
 *	for ISOTZone.
 */
public class CFSecOracleISOTZoneTable
	implements ICFSecISOTZoneTable
{
	...
	public CFSecOracleISOTZoneTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOTZoneBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOTZoneId )
	{
		final String S_ProcName = "CFSecOracleISOTZoneTable.readDerivedByIdIdx() ";
		CFSecISOTZoneBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOTZoneBuff readDerivedByUTZNameIdx( CFSecAuthorization Authorization,
		String TZName )
	{
		final String S_ProcName = "CFSecOracleISOTZoneTable.readDerivedByUTZNameIdx() ";
		CFSecISOTZoneBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
