...
/*
 *	CFSecOracleSecGrpIncTable Oracle Jdbc DbIO implementation
 *	for SecGrpInc.
 */
public class CFSecOracleSecGrpIncTable
	implements ICFSecSecGrpIncTable
{
	...
	public CFSecOracleSecGrpIncTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGrpIncBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpIncId )
	{
		final String S_ProcName = "CFSecOracleSecGrpIncTable.readDerivedByIdIdx() ";
		CFSecSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpIncBuff readDerivedByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFSecOracleSecGrpIncTable.readDerivedByUIncludeIdx() ";
		CFSecSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
