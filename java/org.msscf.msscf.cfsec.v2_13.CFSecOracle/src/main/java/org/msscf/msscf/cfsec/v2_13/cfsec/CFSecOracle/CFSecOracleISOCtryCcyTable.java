...
/*
 *	CFSecOracleISOCtryCcyTable Oracle Jdbc DbIO implementation
 *	for ISOCtryCcy.
 */
public class CFSecOracleISOCtryCcyTable
	implements ICFSecISOCtryCcyTable
{
	...
	public CFSecOracleISOCtryCcyTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOCcyId )
	{
		final String S_ProcName = "CFSecOracleISOCtryCcyTable.readDerivedByIdIdx() ";
		CFSecISOCtryCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
