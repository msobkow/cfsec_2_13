...
/*
 *	CFSecOracleSecUserTable Oracle Jdbc DbIO implementation
 *	for SecUser.
 */
public class CFSecOracleSecUserTable
	implements ICFSecSecUserTable
{
	...
	public CFSecOracleSecUserTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecUserBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		UUID SecUserId )
	{
		final String S_ProcName = "CFSecOracleSecUserTable.readDerivedByIdIdx() ";
		CFSecSecUserBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecUserBuff readDerivedByULoginIdx( CFSecAuthorization Authorization,
		String LoginId )
	{
		final String S_ProcName = "CFSecOracleSecUserTable.readDerivedByULoginIdx() ";
		CFSecSecUserBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
