...
/*
 *	CFSecOracleServiceTable Oracle Jdbc DbIO implementation
 *	for Service.
 */
public class CFSecOracleServiceTable
	implements ICFSecServiceTable
{
	...
	public CFSecOracleServiceTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecServiceBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long ServiceId )
	{
		final String S_ProcName = "CFSecOracleServiceTable.readDerivedByIdIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceBuff readDerivedByUTypeIdx( CFSecAuthorization Authorization,
		...
		int ServiceTypeId )
	{
		final String S_ProcName = "CFSecOracleServiceTable.readDerivedByUTypeIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceBuff readDerivedByUHostPortIdx( CFSecAuthorization Authorization,
		...
		short HostPort )
	{
		final String S_ProcName = "CFSecOracleServiceTable.readDerivedByUHostPortIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
