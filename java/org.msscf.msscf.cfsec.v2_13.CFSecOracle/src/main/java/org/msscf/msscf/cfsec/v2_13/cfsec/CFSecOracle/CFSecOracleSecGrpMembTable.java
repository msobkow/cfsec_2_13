...
/*
 *	CFSecOracleSecGrpMembTable Oracle Jdbc DbIO implementation
 *	for SecGrpMemb.
 */
public class CFSecOracleSecGrpMembTable
	implements ICFSecSecGrpMembTable
{
	...
	public CFSecOracleSecGrpMembTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpMembId )
	{
		final String S_ProcName = "CFSecOracleSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFSecOracleSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
