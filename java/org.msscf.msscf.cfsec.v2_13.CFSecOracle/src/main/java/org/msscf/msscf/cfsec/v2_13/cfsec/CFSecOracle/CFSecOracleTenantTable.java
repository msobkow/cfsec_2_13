...
/*
 *	CFSecOracleTenantTable Oracle Jdbc DbIO implementation
 *	for Tenant.
 */
public class CFSecOracleTenantTable
	implements ICFSecTenantTable
{
	...
	public CFSecOracleTenantTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTenantBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long Id )
	{
		final String S_ProcName = "CFSecOracleTenantTable.readDerivedByIdIdx() ";
		CFSecTenantBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTenantBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String TenantName )
	{
		final String S_ProcName = "CFSecOracleTenantTable.readDerivedByUNameIdx() ";
		CFSecTenantBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
