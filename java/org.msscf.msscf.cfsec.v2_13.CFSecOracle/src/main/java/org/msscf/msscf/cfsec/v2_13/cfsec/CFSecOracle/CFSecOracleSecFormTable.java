...
/*
 *	CFSecOracleSecFormTable Oracle Jdbc DbIO implementation
 *	for SecForm.
 */
public class CFSecOracleSecFormTable
	implements ICFSecSecFormTable
{
	...
	public CFSecOracleSecFormTable( CFSecOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecFormBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecFormId )
	{
		final String S_ProcName = "CFSecOracleSecFormTable.readDerivedByIdIdx() ";
		CFSecSecFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	{
		final String S_ProcName = "CFSecOracleSecFormTable.readDerivedByUJEEServletIdx() ";
		CFSecSecFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
