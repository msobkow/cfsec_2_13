...
/*
 *	CFSecMSSqlClusterTable PostgreSQL Jdbc DbIO implementation
 *	for Cluster.
 */
public class CFSecMSSqlClusterTable
	implements ICFSecClusterTable
{
	...
	public CFSecMSSqlClusterTable( CFSecMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecClusterBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long Id )
	{
		final String S_ProcName = "CFSecMSSqlClusterTable.readDerivedByIdIdx() ";
		CFSecClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecClusterBuff readDerivedByUDomNameIdx( CFSecAuthorization Authorization,
		String FullDomName )
	{
		final String S_ProcName = "CFSecMSSqlClusterTable.readDerivedByUDomNameIdx() ";
		CFSecClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecClusterBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		String Description )
	{
		final String S_ProcName = "CFSecMSSqlClusterTable.readDerivedByUDescrIdx() ";
		CFSecClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
