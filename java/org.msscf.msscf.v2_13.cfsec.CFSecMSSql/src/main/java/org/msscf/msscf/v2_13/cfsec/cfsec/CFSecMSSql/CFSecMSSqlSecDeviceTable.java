...
/*
 *	CFSecMSSqlSecDeviceTable PostgreSQL Jdbc DbIO implementation
 *	for SecDevice.
 */
public class CFSecMSSqlSecDeviceTable
	implements ICFSecSecDeviceTable
{
	...
	public CFSecMSSqlSecDeviceTable( CFSecMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecDeviceBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		String DevName )
	{
		final String S_ProcName = "CFSecMSSqlSecDeviceTable.readDerivedByIdIdx() ";
		CFSecSecDeviceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecDeviceBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String DevName )
	{
		final String S_ProcName = "CFSecMSSqlSecDeviceTable.readDerivedByNameIdx() ";
		CFSecSecDeviceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
