...
/*
 *	CFSecMSSqlISOCtryCcyTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCtryCcy.
 */
public class CFSecMSSqlISOCtryCcyTable
	implements ICFSecISOCtryCcyTable
{
	...
	public CFSecMSSqlISOCtryCcyTable( CFSecMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOCcyId )
	{
		final String S_ProcName = "CFSecMSSqlISOCtryCcyTable.readDerivedByIdIdx() ";
		CFSecISOCtryCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
