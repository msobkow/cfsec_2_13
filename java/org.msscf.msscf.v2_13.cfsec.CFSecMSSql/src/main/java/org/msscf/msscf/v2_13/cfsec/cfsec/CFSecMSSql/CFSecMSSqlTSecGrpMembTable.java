// Description: Java 11 MS SQL Server Developer Edition Jdbc DbIO implementation for TSecGrpMemb.
...
/*
 *	CFSecMSSqlTSecGrpMembTable PostgreSQL Jdbc DbIO implementation
 *	for TSecGrpMemb.
 */
public class CFSecMSSqlTSecGrpMembTable
	implements ICFSecTSecGrpMembTable
{
	...
	public CFSecMSSqlTSecGrpMembTable( CFSecMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpMembId )
	{
		final String S_ProcName = "CFSecMSSqlTSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFSecMSSqlTSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		long argTSecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "exec sp_delete_tsecmemb_by_ididx ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?";
