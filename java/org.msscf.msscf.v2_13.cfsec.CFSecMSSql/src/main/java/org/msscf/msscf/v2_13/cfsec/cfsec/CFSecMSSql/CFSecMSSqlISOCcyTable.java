// Description: Java 11 MS SQL Server Developer Edition Jdbc DbIO implementation for ISOCcy.
...
/*
 *	CFSecMSSqlISOCcyTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCcy.
 */
public class CFSecMSSqlISOCcyTable
	implements ICFSecISOCcyTable
{
	...
	public CFSecMSSqlISOCcyTable( CFSecMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOCcyId )
	{
		final String S_ProcName = "CFSecMSSqlISOCcyTable.readDerivedByIdIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCcyBuff readDerivedByCcyCdIdx( CFSecAuthorization Authorization,
		String ISOCode )
	{
		final String S_ProcName = "CFSecMSSqlISOCcyTable.readDerivedByCcyCdIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCcyBuff readDerivedByCcyNmIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFSecMSSqlISOCcyTable.readDerivedByCcyNmIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		short argISOCcyId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "exec sp_delete_iso_ccy_by_ididx ?, ?, ?, ?, ?" + ", "
				+		"?";
