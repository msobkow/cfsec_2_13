...
/*
 *	CFSecMSSqlISOCtryLangTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCtryLang.
 */
public class CFSecMSSqlISOCtryLangTable
	implements ICFSecISOCtryLangTable
{
	...
	public CFSecMSSqlISOCtryLangTable( CFSecMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOLangId )
	{
		final String S_ProcName = "CFSecMSSqlISOCtryLangTable.readDerivedByIdIdx() ";
		CFSecISOCtryLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
