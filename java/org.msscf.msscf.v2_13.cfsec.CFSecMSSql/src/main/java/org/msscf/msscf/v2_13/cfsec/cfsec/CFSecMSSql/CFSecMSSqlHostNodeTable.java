// Description: Java 11 MS SQL Server Developer Edition Jdbc DbIO implementation for HostNode.
...
/*
 *	CFSecMSSqlHostNodeTable PostgreSQL Jdbc DbIO implementation
 *	for HostNode.
 */
public class CFSecMSSqlHostNodeTable
	implements ICFSecHostNodeTable
{
	...
	public CFSecMSSqlHostNodeTable( CFSecMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecHostNodeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long HostNodeId )
	{
		final String S_ProcName = "CFSecMSSqlHostNodeTable.readDerivedByIdIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecHostNodeBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		...
		String Description )
	{
		final String S_ProcName = "CFSecMSSqlHostNodeTable.readDerivedByUDescrIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecHostNodeBuff readDerivedByHostNameIdx( CFSecAuthorization Authorization,
		...
		String HostName )
	{
		final String S_ProcName = "CFSecMSSqlHostNodeTable.readDerivedByHostNameIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		long argHostNodeId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "exec sp_delete_hostnode_by_ididx ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?";
