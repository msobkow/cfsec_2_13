// Description: Java 11 MS SQL Server Developer Edition Jdbc DbIO implementation for ServiceType.
...
/*
 *	CFSecMSSqlServiceTypeTable PostgreSQL Jdbc DbIO implementation
 *	for ServiceType.
 */
public class CFSecMSSqlServiceTypeTable
	implements ICFSecServiceTypeTable
{
	...
	public CFSecMSSqlServiceTypeTable( CFSecMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecServiceTypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int ServiceTypeId )
	{
		final String S_ProcName = "CFSecMSSqlServiceTypeTable.readDerivedByIdIdx() ";
		CFSecServiceTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceTypeBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		String Description )
	{
		final String S_ProcName = "CFSecMSSqlServiceTypeTable.readDerivedByUDescrIdx() ";
		CFSecServiceTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		int argServiceTypeId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "exec sp_delete_svctype_by_ididx ?, ?, ?, ?, ?" + ", "
				+		"?";
