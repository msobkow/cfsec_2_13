...
/*
 *	CFSecXMsgClntHostNode XMsg Client DbIO implementation
 *	for HostNode.
 */
public class CFSecXMsgClntHostNode
	implements ICFSecHostNodeTable
{
	private CFSecXMsgClntSchema schema;

	public CFSecXMsgClntHostNode( CFSecXMsgClntSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecHostNodeBuff Buff )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstCreate( "\n\t\t\t", Buff )
			+	"\n"
		...
		if( lastObjectProcessed != null ) {
			ICFSecHostNodeObj realised = null;
			if( lastObjectProcessed instanceof ICFSecHostNodeObj ) {
				realised = (ICFSecHostNodeObj)lastObjectProcessed;
			}
			else {
		...
		CFSecHostNodePKey PKey )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstRead( "\n\t\t\t", PKey )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFSecHostNodePKey PKey )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstLock( "\n\t\t\t", PKey )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
	...
	public CFSecHostNodeBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstReadAll( "\n\t\t\t" )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		long argHostNodeId )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstRdByIdIdx( "\n\t\t\t",
							argClusterId,
							argHostNodeId )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		long argClusterId )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstRdByClusterIdx( "\n\t\t\t",
							argClusterId )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		String argDescription )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstRdByUDescrIdx( "\n\t\t\t",
							argClusterId,
							argDescription )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		String argHostName )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstRdByHostNameIdx( "\n\t\t\t",
							argClusterId,
							argHostName )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		Long priorHostNodeId )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstPageAll( "\n\t\t\t",
							priorClusterId,
							priorHostNodeId )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		Long priorHostNodeId )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstPageByClusterIdx( "\n\t\t\t",
						ClusterId,
							priorClusterId,
							priorHostNodeId )
			+	"\n"
		...
		CFSecHostNodeBuff Buff )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstUpdate( "\n\t\t\t", Buff )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFSecHostNodeBuff Buff )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstDelete( "\n\t\t\t", Buff )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		long argHostNodeId )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstDelByIdIdx( "\n\t\t\t",
							argClusterId,
							argHostNodeId )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		long argClusterId )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstDelByClusterIdx( "\n\t\t\t",
							argClusterId )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		String argDescription )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstDelByUDescrIdx( "\n\t\t\t",
							argClusterId,
							argDescription )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		String argHostName )
	{
		...
		String rqst = CFSecXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRqstDelByHostNameIdx( "\n\t\t\t",
							argClusterId,
							argHostName )
			+	"\n"
			+	CFSecXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
